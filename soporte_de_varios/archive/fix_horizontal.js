...
const bestDesc = '[Scope] Ultra-Premium Commercial Grade (Horizontal y Vertical): Up to 4 baths, fully sized for high flow rates (1 inch mains). Reemplazo de 100% de la infraestructura desde el medidor hasta caída accesorio en la casa. Complete Type L Copper installation with ProPress. Includes permit expediting.';
...
const htmlBetter = 'Repipe Premium (Horizontal y Vertical): Hasta 3 banos, 1 cocina, lavanderia. Cobertura 100% de la casa (desde las lineas horizontales principales hasta las caidías verticales en caída pared). Sistema PEX-A. Incluye masilla cortafuego (firestop) y parcheo de yeso.';
html = html.replace(/Repipe Premium:[^"]+/, htmlBetter);

const htmlBest = 'Grado Comercial Ultra-Premium (Horizontal y Vertical): Hasta 4 banos. Reemplazo del 100% de la infraestructura de la propiedad desde el medidor hasta caída fixture de la casa, utilizando Cobre Tipo L sin soldadura (ProPress). Incluye gestion rapida de permisos y parcheo total.';
