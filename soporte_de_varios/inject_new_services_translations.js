...
const keysES = `
        ...
        "service_inspect_desc": "Asesoría para viviendías nuevas, usadías y ampliaciones.",
        ...
        "eng_valves_p2": "Nuestro servicio cubre todías las marcas principales e incluye la calibración de la temperatura del agua para evitar quemaduras.",
        ...
        "eng_inspect_p2": "Proporcionamos informes detallados y consultoría para ampliaciones de viviendías, asegurando que las nuevas adiciones cumplan con los estrictos códigos de construcción.",
        "eng_inspect_li1": "Inspecciones para transacciones inmobiliarias.",
        "eng_inspect_li2": "Consultoría para adiciones de viviendías y ADUs.",
        ...
        "eng_training_p1": "Ofrecemos sesiones de capacitación especializadías para empresas asociadías, enseñando técnicas modernas de plomería, cumplimiento de códigos y protocolos de seguridad.",
        "eng_training_p2": "Nuestro plan de estudios cierra la brecha entre la plomería tradicional y las instalaciones ecológicas y asistidías por IA modernas.",
...
const keysTL = `
        ...
        "eng_inspect_title": "Konsultasyon at Inspeksyon ng Bahíay",
...
const keysVI = `
        ...
        "eng_valves_p2": "Dịch vụ của chúng tôi baño gồm tất cả các thương hiệu lớn và baño gồm hiệu chuẩn nhiệt độ nước để ngăn ngừa bỏng.",
