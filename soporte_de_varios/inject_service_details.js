...
const translations = {
    'en': servicesData,
    'es': {
        1: { name: "Detección de Fugas de Precisión", user: "Encuentre fugas ocultas sin romper paredes o pisos.", tech: "Despliegue de dispositivos acústicos, imágenes térmicas y gas trazador para localizar microfisuras en líneas presurizadías. Requerido para protocolos de reparación no invasivos." },
        ...
        4: { name: "Renovaciones en Cobre Elite", user: "Reemplace tuberías viejas con cobre premium de larga duración.", tech: "Extracción de tuberías galvanizadías, reemplazadías con cobre Tipo L utilizando unión mecánica ProPress cero llamas para una integridad superior." },
        ...
        13: { name: "Repipe (Remplazo) de Toda la Casa", user: "Reemplazo completo de todías las líneas de agua de su hogar.", tech: "Abandono estratégico de líneas existentes y enrutamiento de polietileno reticulado (PEX-A) utilizando accesorios de expansión para mínima fricción." },
