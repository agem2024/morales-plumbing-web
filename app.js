...
"profile_role": "Principal technician & Founder",
    ...
    "es": {
        "stats_years_num": "15+",
        "stats_years_text": "Aos de Experiencia",
        "stats_projects_num": "500+",
        ...
        "qs_desc": "Selecciona tu necesidad y solicita cotizacin al instante.",
        ...
        "diy_custom_desc": "Describe libremente tu problema a Joe AI para obtener un Diagnstico en tiempo real, materiales y presupuesto estimado.",
        ...
        "svc_1_good_desc": "Resolucin mediante un Diagnstico visual y acstico bsico. Se emplea un parche estndar y equipo manual para fugas accesibles. Ideal para reparaciones rpidas de bajo impacto.",
        ...
        "svc_1_best_desc": "Mapeo estructural completo y aislamiento sectorizado. Reparacin definitiva utilizando un segmento de repipe en Cobre Tipo L con tecnologa de prensado ProPress. Esta es la solucin de grado comercial que garantiza integridad a largo plazo.",
        "svc_2_good_desc": "Reemplazo utilizando tubera PEX-B con conectores tipo Crimp. Incluye prueba de presin a 100 PSI. Es una solucin confiable y econmica para restablecer la funcionalidad del sistema.",
        ...
        "svc_5_best_desc": "Inspeccin HD y modelado. Mapeo completo del sistema, trazado de sonar y reporte de Plomera Tcnica digital detallando pendientes, intrusiones y opciones de recubrimiento sin zanja (CIPP).",
        ...
        "svc_8_better_desc": "Wilkins 600XL con manmetro de lectura integrada. Permite un monitoreo visual y ajustes precisos sin requerir herramientas adicionales de Diagnstico.",
        ...
        "promo_ttt_best_comic_1": "1. Instalacin Ultra-Premium incluyendo Diagnstico total de tuberas.",
        ...
        "pb_svc_7_best_tools": "Manmetros de Diagnstico, termografa (para ajuste de recirculacin), herramientas de anclaje pesado.",
        ...
        "dash_feedback_desc": "Tu opinin nos ayuda a retroalimentar la IA Joe y mejorar nuestra Plomera Tcnica.",
        ...
        "btn_confirm_appointment": "Confirmar Cita de Plomera Tcnica",
        ...
        "maint_premium": " Beneficio Premium: 2 Inspecciones Preventivas Anuales Gratuitas (Diagnstico SeeSnake, anlisis qumico del agua, calibracin de PRV o termografa). Agende a travs de PQR o hable con Joe AI para programar.",
        ...
        "eng_eco_tech1_desc": "Instalacin de reguladores de flujo aerados, inodoros dual-flush de ultra-bajo consumo (UHET) y vlvulas inteligentes de reduccin de presin (PRV).",
        ...
        "eng_diseno_code": "ENG-CENT-003",
        "eng_diseno_p1": "El Diseo de Sistemas de Tuberas de Morales Plumbing es un servicio avanzado de Plomera Tcnica que garantiza la viabilidad, eficiencia y escalabilidad.",
        ...
        "svc_1_good": "<strong>Nivel GOOD (estndar)  $450 - $700</strong><br>Diagnstico visual y acustico basico. Parche estndar para fugas accesibles.",
        ...
        "svc_5_title": "SeeSnake Camera Inspection",
        "svc_5_p1": "El Diagnstico a ciegas destruye propiedades. Nuestras camaras HD trazan el problema sin excavar.",
        ...
        "nav_services": "Plomera Tcnica Pro",
        "nav_multimedia": "Podcasts",
        "nav_about": "Misin",
        "nav_terminal": "Terminal",
        "hero_badge": "Plomera Tcnica PROFESIONAL Y CERTIFICACIN CSLB C-36",
        "hero_title": "MORALES PLUMBING",
        "hero_desc": "Integrando ms de 21 aos de experiencia en Plomera Tcnica con estimacin por IA y diseo hidrulico sostenible.",
        "stat_ready": "Licenciado",
        "stat_eco": "ISO 14001",
        "stat_ai": "IA Activa",
        "hero_explore": "Ver Soluciones",
        "hero_joe": "Asistente Joe",
        "projects_title": "Excelencia en Plomera Tcnica",
        ...
        "joe_status": "JOE: ASISTENTE DE Plomera Tcnica AI",
        ...
        "app_pricebook_detail": "El Libro de Precios Orion v6.0 PRO es una herramienta de Plomera Tcnica de costos que estandariza las tarifas de servicio en todo el rea de la Baha. Utiliza un sistema de niveles (Bueno/Mejor/Excelente) para ofrecer opciones flexibles que cumplen con los estndares de seguridad UPC.",
        ...
        "app_redes_detail": "Software de diseo hidrulico con integracin CAD que permite modelar flujos, presiones y gradientes trmicos. Esencial para infraestructura de alta complejidad en el rea de la Baha.",
        ...
        "service_copper_comp": "Superamos a la competencia que utiliza PEX de baja densidad y uniones mecnicas propensas a fallas por presin.",
        "service_copper_plus": "Plomera Tcnica Sostenible: Protocolos de sanitizacin post-instalacin y certificacin de soldadura sin plomo.",
        ...
        "service_construction_content": "Planificacin desde el nivel de cimentacin, rough-in de alta velocidad y acabados de Plomera Tcnica premium.",
        ...
        "service_construction_costs": "Optimizacin del presupuesto mediante Plomera Tcnica de valor y seleccin estratgica de materiales.",
        ...
        "service_water_comp": "Diseos personalizados frente a barriles de lluvia simples; nosotros entregamos Plomera Tcnica de filtracin de grado 2.",
        "service_water_plus": "Plomera Tcnica Sostenible: Sistemas de desinfeccin UV integrados para prevenir la proliferacin de patgenos.",
        ...
        "mission_title": "MISIN",
        "mission_desc": "Liderar la industria integrando ms de 21 aos de experiencia en Plomera Tcnica con inteligencia artificial, ofreciendo soluciones de alta precisin bajo los estndares regulatorios de la CSLB y el Cdigo Uniforme de Plomera (UPC).",
        "vision_title": "VISIN",
        "vision_desc": "Ser el estndar global para la fontanera tcnica y la Plomera Tcnica sostenible  definido por la innovacin constante, la excelencia operativa y la integridad absoluta en cada proyecto.",
        "terminal_title": "MORALES_EXECUTIVE_V1.0",
...
"profile_role": "Ingeniero Principal y Fundador",
        ...
        "cat_eco": "Sostenible",
        "cat_technical plumbing": "Plomera Tcnica",
        ...
        "pb_method_p1": "La metodologa de clculo de ORION se basa en un enfoque de Plomera Tcnica de precisin para el costeo hidrulico. Utilizamos algoritmos de grado industrial que consideran la durabilidad del material, la intensidad de la mano de obra (categorizada por roles de Lder y Ayudante) y la complejidad tcnica. Esto elimina la variabilidad de la estimacin, proporcionando una estructura de tarifa fija alineada con los estndares de la CSLB y la volatilidad del mercado de la construccin en California.",
        ...
        "pb_promo_p1": "El marco de promociones de Morales Plumbing recompensa el mantenimiento proactivo y los compromisos de proyectos de gran volumen. Ofrecemos incentivos peridicos para el cambio de tuberas en todo el hogar, optimizaciones estacionales de calentadores de agua e integraciones de ORION Tech por primera vez. Estas promociones estn diseadas para reducir la barrera de entrada a soluciones de Plomera Tcnica de alta precisin.",
        "pb_promo_p2": "Todas las promociones activas estn sujetas a revisin de Plomera Tcnica y no pueden combinarse con otros descuentos estratgicos, asegurando que la calidad del proyecto siga siendo la prioridad absoluta.",
        "pb_terms_p1": "Todos los servicios proporcionados por Morales Plumbing se rigen por la Junta de Licencias del Estado de Contratistas de California (CSLB) y el Cdigo Uniforme de Plomera (UPC). Cada contrato incluye un alcance detallado del trabajo, precios de tarifa fija (sin tarifas ocultas) y una declaracin clara de la metodologa tcnica. Los pagos estn estructurados para alinearse con los hitos del proyecto.",
        "pb_terms_p2": "La responsabilidad y la resolucin de disputas siguen los estndares industriales de California, asegurando una asociacin profesional y transparente entre el equipo de Plomera Tcnica y el cliente.",
        "pb_warranty_p1": "Morales Plumbing ofrece una garanta estndar de 1 ao en toda la mano de obra e integraciones tcnicas, con garantas extendidas disponibles para sistemas de nivel 'Excelente' e instalaciones de ORION Tech. Adems, contamos con planes de crdito y sistemas de garanta en mano de obra de por vida con repipe completo, ya sea de agua, drenaje o gas. Nuestro equipo de soporte utiliza datos de monitoreo de IoT para proporcionar respuestas de Diagnstico rpidas, minimizando el tiempo de inactividad y asegurando la integridad del sistema.",
        ...
        "pb_warranty_note": "*Monitoreo de IoT:* Se refiere al uso de tecnologa inteligente (vlvulas de corte de agua Wi-Fi, sensores de fugas, calentadores inteligentes) que envan datos y alertas a la nube para un Diagnstico preventivo rpidas.",
        "pb_prose_p1": "El ORION Price Book v6.0 PRO es el ncleo operativo de Morales Plumbing, diseado para ofrecer una transparencia absoluta en la Plomera Tcnica de costos. Este catlogo, actualizado a diciembre de 2024 para el rea de la Baha de California, ha sido desarrollado bajo los rigurosos lineamientos de la Junta de Licencias del Estado de Contratistas de California (CSLB) y el Cdigo Uniforme de Plomera (UPC), asegurando que cada intervencin tcnica estrespaldada por estndares de seguridad industrial y sostenibilidad ambiental.",
        ...
        "hn_prose_p3": "Hydraulic Nexus tambin se integra con nuestros diagnsticos de termografa, permitindonos superponer datos trmicos en tiempo real sobre los planos originales para una deteccin de fugas y auditora de infraestructura precisas. Es la herramienta definitiva para la Plomera Tcnica Avanzada de precisin.",
        "wh_title": "ORION THERMO CORE v2.0",
        ...
        "aca_hero_desc": "Misin, visin, valores, estructura organizacional y cultura de la empresa. Este mdulo te dar las bases para entender quines somos y hacia dnde vamos.",
        ...
        "service_expansion_detail": "CONTENIDO: Bloques de expansin hidrulica modular. PROPSITO: Integracin perfecta de nuevos accesorios sin prdida de presin. USO: Adiciones comerciales y ampliaciones residenciales. POTENCIALIDADES: Escalabilidad infinita. COSTOS: Evita el rediseo total del sistema. PLUS: Plomera Tcnica avanzada y procesos Lean. COPYRIGHT:  2026 Morales Plumbing. Todos los derechos reservados.",
        "service_construction_title": "Plomera Tcnica de Obra Nueva",
        ...
        "service_water_desc": "Plomera Tcnica de captura de lluvia y reutilizacin de aguas grises estratgicas.",
        ...
        "faq_a5": "Combina la experiencia CSLB C-36 con Plomera Tcnica Sostenible, diagnsticos por IA y Proceso Lean, brindando un nivel de precisin y sostenibilidad inigualable.",
        "faq_q6": "Cmo asegura Morales Plumbing el cumplimiento del UPC?",
        "faq_a6": "Nuestros ingenieros cuentan con certificacin CSLB C-36 y utilizan protocolos de verificacin por IA para asegurar que cada conexin supere los estndares de California. Adems, ofrecemos inspecciones fsicas tradicionales de doble inspector y listas de verificacin manuales para clientes que prefieren la supervisin mecnica clsica. <span class=\"comic-choice\">La decisin es suya</span>: elija nuestra validacin digital de alta precisin asistida por IA, o nuestra inspeccin humana manual probada en el tiempo con garantas mecnicas.",
        ...
        "profile_header_role": "Liderazgo en Plomera Tcnica",
...
"profile_role": "?????????",
        ...
        "pb_promo_p2": "??????????????,??????????????,??????????????????",
        "pb_terms_p1": "Morales Plumbing ???????????????????? (CSLB) ??????? (UPC) ?????????????????????????(?????)??????????????????????????????",
        "pb_terms_p2": "???????????????,??????????????????????????",
    ...
    "tl": {
        ...
        "faq100_a_16": "Inirerekomenda na itakda ito sa 120F (49C) upang maiwasan ang pagkasunog at makatipid ng enerhiya.",
        ...
        "eng_termo_tech1_desc": "Kinukuha ng aming mga camera ang mga pagkakaiba sa temperatura na hanggang 0.1C, na eksaktong ipinapakita kung saan dumadaloy ang tumagas na tubig.",
        "eng_termo_tech2_title": "Computerized Acoustic Analysis",
...
"profile_role": "Principal technician & Tagapagtatag",
    ...
    "vi": {
        ...
        "stats_projects_num": "500+",
        "stats_projects_text": "D? n d Hon thnh",
        "stats_hours_num": "24/7",
        "stats_hours_text": "Tru?ng h?p kh?n c?p",
        "stats_lic_num": "C-36",
        "stats_lic_text": "Gi?y php CSLB #1156542",
        "qs_title": "B?n c?n d?ch v? g?",
        "qs_desc": "Ch?n nhu c?u c?a b?n v yu c?u bo gi ngay l?p t?c.",
        "lp_h1": "Become a Home Expert",
        "lp_sub": "The ultimate step-by-step guide to repair and improve your home without spending hundreds of dollars on service calls or complex tools.",
        "lp_cta1": "Start Building & Fixing!",
        "lp_hook_title": "Afraid of DIY Repairs?",
        ...
        "htm_hvac_filter_desc": "C?i thi?n ch?t lu?ng khng khv hi?u su?t my l?nh.",
        "htm_drain_heater_title": "Drain Water Heater",
        "htm_drain_heater_desc": "Flush sediment to extend heater life.",
        "htm_heater_temp_title": "Adjust Heater Temp",
        "htm_heater_temp_desc": "Set to 120F for safety and savings.",
        ...
        "htm_gfi_desc": "Khi ph?c ngu?n di?n phng t?m an ton.",
        "htm_anode_title": "Ki?m tra thanh Anode",
        "htm_anode_desc": "Ko di tu?i th? c?a my nu?c nng.",
        "htm_drain_heater_title": "X? my nu?c nng",
        "htm_drain_heater_desc": "X? c?n t? bnh ch?a c?a b?n.",
        "htm_plunge_toilet_title": "Thng t?c b?n c?u",
        "htm_plunge_toilet_desc": "Thng b?n c?u b? t?c b?ng ?ng th?t.",
        "htm_main_filter_title": "Thay th? b? l?c chnh",
        "htm_main_filter_desc": "Gi? cho ngu?n nu?c ton b? ngi nh c?a b?n s?ch s?.",
        "htm_dishwasher_filter_title": "Lm s?ch b? l?c my r?a bt",
        "htm_dishwasher_filter_desc": "Ngan ng?a mi hi v lm s?ch km.",

        "htm_title": "T? lm",
        "htm_subtitle": "Top 10 S?a ch?a D? dng t? FAQ 100",
        "htm_joe_title": "Tr? l Joe AI",
        "htm_joe_desc": "Ch?n m?t tc v? d? tnh ton v?t li?u ho?c yu c?u di?u hu?ng.",
        "htm_calc_btn": "Tnh ton V?t li?u",
        "htm_materials": "V?t li?u c?n thi?t",
        "htm_tools": "Cng c? c?n thi?t",
        "htm_steps": "T?ng bu?c m?t",
        "htm_disposal_title": "Tho k?t my xay rc",
        "htm_disposal_desc": "D? dng gi?i phng d?ng co b? k?t.",
        "htm_heater_title": "?t l?i My nu?c nng",
        "htm_heater_desc": "Khi ph?c nu?c nng sau khi ng?t di?n.",
        "htm_toilet_title": "S?a b?n c?u ch?y nu?c",
        "htm_toilet_desc": "Ng?ng dng nu?c ch?y lin t?c.",
        "htm_sink_title": "Lm s?ch P-Trap",
        "htm_sink_desc": "Thng t?c b?n r?a c?a b?n.",
        "htm_aerator_title": "Lm s?ch s?c kh",
        "htm_aerator_desc": "Kh?c ph?c p l?c nu?c y?u.",
        "htm_faucet_title": "S?a vi nu?c r r?",
        "htm_faucet_desc": "Ng?ng nh? gi?t khch?u.",
        "htm_caulk_title": "Trm l?i B?n t?m",
        "htm_caulk_desc": "Ngan ng?a hu h?ng v n?m m?c.",
        "htm_showerhead_title": "Thay vi hoa sen",
        "htm_showerhead_desc": "Nng c?p tr?i nghi?m t?m.",
        "htm_smell_title": "Lo?i b? mi c?ng",
        "htm_smell_desc": "Ch?n khb?ng cch d? nu?c.",
        "htm_washer_hose_title": "Thay ?ng my gi?t",
        "htm_washer_hose_desc": "Ngan ch?n lu l?t phng gi?t.",

        "diy_custom_title": "Ch?n don nh AI",
        "diy_custom_desc": "M t? v?n d? c?a b?n cho Joe AI d? du?c ch?n don, v?t li?u v d? ton ngn sch theo th?i gian th?c.",
        "diy_disposal_title": "K?t my xay rc",
        "diy_disposal_desc": "Tm hi?u cch tho k?t an ton b?ng c? l Allen trong chua d?y 2 pht.",
        "diy_heater_title": "Kh?i d?ng l?i my nu?c nng",
        "diy_heater_desc": "Khng cnu?c nng? Hu?ng d?n t?ng bu?c d? ki?m tra dn hoa tiu v d?t l?i cng t?c nhi?t.",
        "diy_toilet_title": "S?a b?n c?u ch?y nu?c",
        "diy_toilet_desc": "Ng?ng lng phnu?c. Xc d?nh van cao su h?ng ho?c di?u ch?nh phao c?p nu?c ngay l?p t?c.",
        "diy_sink_title": "Thng t?c P-Trap b?n r?a",
        "diy_sink_desc": "Lm s?ch b?n r?a m?t ho?c b?n r?a bt b? t?c m khng c?n ha ch?t d?c h?i.",
        "diy_shower_title": "p l?c vi sen y?u",
        "diy_shower_desc": "T?y c?n vi hoa sen c?a b?n d? ph?c h?i luu lu?ng v p l?c t?i da.",
        "diy_valve_title": "Kha nu?c kh?n c?p",
        "diy_valve_desc": "?nh v? v kha van nu?c chnh c?a b?n d? ngan ng?a thi?t h?i do ng?p l?t.",
        "diy_faucet_title": "S?a vi nu?c r r?",
        "diy_faucet_desc": "Ch?m d?t vi?c nh? gi?t khch?u b?ng cch thay th? li bn trong.",
        "diy_gfi_title": "?t l?i ? c?m GFI",
        "diy_gfi_desc": "Khng cdi?n cho my xay rc ho?c my nu?c nng? Th? d?t l?i di?n nhanh chng.",
        "diy_smell_title": "Lo?i b? mi c?ng",
        "diy_smell_desc": "Kh?c ph?c mi hi pht ra t? c?ng thot nu?c c?a b?n b?ng cch m?i b?y nu?c don gi?n.",

        "diy_tankless_flush_title": "X? my nu?c nng",
        "diy_tankless_flush_desc": "T?y c?n my nu?c nng khng bnh d? duy tr hi?u su?t.",
        "diy_caulk_title": "Trm l?i b?n t?m",
        "diy_caulk_desc": "B?t kn b?n t?m d? trnh hu h?ng do nu?c v n?m m?c.",
        "diy_aerator_title": "Lm s?ch s?c khvi",
        "diy_aerator_desc": "Khi ph?c p l?c nu?c b?ng cch lm s?ch c?n b?n.",
        "diy_washer_hose_title": "Thay ?ng my gi?t",
        "diy_washer_hose_desc": "Thay ?ng cu d? ngan ch?n lu l?t nghim tr?ng.",
        "diy_dishwasher_title": "Thot nu?c my r?a bt",
        "diy_dishwasher_desc": "Lm s?ch khe h? khng khho?c ?ng thot nu?c b? t?c.",
        "diy_showerhead_title": "Nng c?p vi hoa sen",
        "diy_showerhead_desc": "L?p vi hoa sen m?i m?t cch chuyn nghi?p khng r r?.",
        ...
        "service_valves_title": "Van & Li l?c",
        "service_valves_desc": "Thay van cho vi hoa sen, b?n t?m v b?n r?a.",
        "service_inspect_title": "Ki?m tra",
        "service_inspect_desc": "Tu v?n cho nh m?i/cu v nh m? r?ng.",
        "service_training_title": "o t?o nhn s?",
        "service_training_desc": "o t?o cho nhn vin cng ty d?i tc.",
        "service_b2b_title": "H?p tc B2B chuyn nghi?p",
        "service_b2b_desc": "H?p tc v?i cc cng ty trong ngnh cho cc d? n ph?c t?p.",

        "eng_wh_title": "B?o tr v l?p d?t my nu?c nng",
        "eng_wh_desc": "D?ch v? my nu?c nng ton di?n t? b?o tr d?nh k? d?n thay th? ton b? h? th?ng.",
        "eng_wh_p1": "Cc chuyn gia c?a chng ti d?m b?o my nu?c nng c?a b?n ho?t d?ng hi?u qu?. Chng ti cung c?p d?ch v? sc r?a, thay th? thanh anode v l?p d?t chnh xc cc h? th?ng khng bnh ch?a ho?c tiu chu?n.",
        "eng_wh_p2": "Chng ti tun th? t?t c? cc quy d?nh d?a phuong v tiu chu?n BAAQMD d? d?t du?c s? an ton v hi?u su?t t?i da.",
        "eng_wh_li1": "Sc r?a v t?y c?n chuyn nghi?p.",
        "eng_wh_li2": "Chuy?n d?i v nng c?p h? th?ng khng bnh ch?a.",
        "eng_wh_li3": "L?p d?t v th? nghi?m tun th? quy d?nh.",

        "eng_valves_title": "Thay th? Li l?c & Van",
        "eng_valves_desc": "Thay th? chnh xc cc van b? l?i c?a vi hoa sen, b?n t?m v b?n r?a.",
        "eng_valves_p1": "M?t van vi hoa sen ho?c b?n r?a b? r r? khng ch? lng phnu?c m cn cth? gy h?ng hc bn trong tu?ng. Chng ti nhanh chng thay th? cc li l?c b? mn v l?p d?t cc van cn b?ng p su?t ch?t lu?ng cao m?i.",
        "eng_valves_p2": "D?ch v? c?a chng ti bao g?m t?t c? cc thuong hi?u l?n v bao g?m hi?u chu?n nhi?t d? nu?c d? ngan ng?a b?ng.",
        "eng_valves_li1": "Thay van vi hoa sen v b?n t?m.",
        "eng_valves_li2": "S?a ch?a li l?c b?n r?a m?t.",
        "eng_valves_li3": "i?u ch?nh gi?i h?n nhi?t d?.",

        "eng_inspect_title": "Tu v?n & Ki?m tra Nh",
        "eng_inspect_desc": "Ki?m tra h? th?ng ?ng nu?c chuyn nghi?p cho nh m?i v cu.",
        "eng_inspect_p1": "Tru?c khi mua ho?c s?a ch?a nh, vi?c ki?m tra h? th?ng ?ng nu?c ton di?n c?a chng ti s? ti?t l? nh?ng v?n d? ti?m ?n trong du?ng ?ng c?ng, p su?t nu?c v cc thi?t b?.",
        "eng_inspect_p2": "Chng ti cung c?p bo co chi ti?t v tu v?n cho vi?c m? r?ng nh ?, d?m b?o cc ph?n xy thm dp ?ng cc quy d?nh xy d?ng nghim ng?t.",
        ...
        "eng_training_title": "o t?o nhn s? doanh nghi?p",
        "eng_training_desc": "Cc chuong trnh do t?o chuyn nghi?p cho cc cng ty d?i tc.",
        "eng_training_p1": "Chng ti cung c?p cc kha do t?o chuyn su cho cc cng ty d?i tc, gi?ng d?y cc k? thu?t h? th?ng ?ng nu?c hi?n d?i, tun th? quy d?nh v cc giao th?c an ton.",
        "eng_training_p2": "Chuong trnh gi?ng d?y c?a chng ti thu h?p kho?ng cch gi?a h? th?ng ?ng nu?c truy?n th?ng v cc cng trnh l?p d?t thn thi?n v?i mi tru?ng, du?c h? tr? b?i AI hi?n d?i.",
        "eng_training_li1": "o t?o th?c hnh l?p d?t.",
        "eng_training_li2": "Tun th? quy d?nh v tiu chu?n an ton.",
        "eng_training_li3": "S? d?ng cc cng c? ch?n don hi?n d?i.",

        "eng_b2b_title": "H?p tc Thuong m?i B2B",
        "eng_b2b_desc": "H?p tc chuyn mn v?i cc nh th?u v ngnh ngh? khc.",
        "eng_b2b_p1": "Morales Plumbing h?p tc v?i cc nh th?u HVAC, di?n v nh th?u chung d? cung c?p h? tr? chuyn mn v? h? th?ng ?ng nu?c cho cc d? n quy m l?n, ph?c t?p.",
        "eng_b2b_p2": "Cc d?ch v? B2B c?a chng ti d?m b?o tch h?p li?n m?ch cc h? th?ng ?ng nu?c trong mi tru?ng xy d?ng da ngnh ngh?.",
        "eng_b2b_li1": "K h?p d?ng ph? cho cc cng trnh l?p d?t ph?c t?p.",
        "eng_b2b_li2": "Tch h?p h? th?ng cho ngnh.",
        "eng_b2b_li3": "H? tr? qu?n l d? n chuyn d?ng.",
        ...
        "svc_1_step_4": "Ki?m tra luu lu?ng v khi ph?c.",
        ...
        "svc_3_step_1": "M hnh ha BIM 3D.",
        "svc_3_step_2": "M ph?ng gradient p su?t.",
        "svc_3_step_3": "Ki?m tra tun th? m.",
        "svc_3_step_4": "Giao b?n thi?t k? cu?i cng.",
        ...
        "svc_6_step_2": "L?p d?t ?ng nu?c trn cao.",
        "svc_6_step_3": "Thi?t l?p thi?t b?.",
        "svc_6_step_4": "Vu?t qua ki?m tra thnh ph?.",
        ...
        "svc_9_step_3": "Phn tch d? li?u.",
        "svc_9_step_4": "T?o bo co k? thu?t s?.",
        "svc_10_step_1": "nh giluu v?c.",
        "svc_10_step_2": "V? trd?t b? ch?a.",
        "svc_10_step_3": "Thi?t l?p l?c.",
        "svc_10_step_4": "Tch h?p tu?i tiu.",
        "svc_11_step_1": "Tnh ton du?ng ?ng gas.",
        "svc_11_step_2": "G?n ch?t vo tu?ng.",
        "svc_11_step_3": "L?p d?t h? th?ng thng gi.",
        "svc_11_step_4": "Th? nghi?m nu?c nng v t?n.",
        "svc_12_step_1": "V? trdu?ng ?ng chnh.",
        "svc_12_step_2": "Lo?i b? ph?n ?ng.",
        "svc_12_step_3": "Tch h?p van thng minh.",
        "svc_12_step_4": "Th? nghi?m k?t n?i ?ng d?ng.",
        "svc_13_step_1": "L?p b?n d? tu?ng kh.",
        "svc_13_step_2": "Ko PEX/?ng.",
        "svc_13_step_3": "C?u hnh ?ng gp.",
        "svc_13_step_4": "Vv son.",
        "svc_14_step_1": "Chuy?n hu?ng c?ng.",
        "svc_14_step_2": "V? trd?t b? tang p.",
        "svc_14_step_3": "Lm s?ch b? l?c.",
        "svc_14_step_4": "Th? nghi?m tu?i vu?n.",
        "svc_15_step_1": "Ki?m ton c?u trc.",
        "svc_15_step_2": "Gi?ng ch?ng d?ng d?t.",
        "svc_15_step_3": "Ki?m tra an mn.",
        "svc_15_step_4": "C?p ch?ng nh?n.",

        "lbl_starting_at": "Kho?n d?u tu u?c tnh b?t d?u t?:",
        "lbl_est_range": "*Chi phcu?i cng thay d?i ty thu?c vo dnh git?i ch?, yu c?u m v nng c?p di?n/khd?t.",
        "promo_wp_good_comic_1": "1. X? v tho bnh nng l?nh gas cu.",
        "promo_wp_good_comic_2": "2. L?p d?t bom nhi?t hybrid tiu chu?n.",
        "promo_wp_good_comic_3": "3. ?m b?o tun th? cc quy d?nh BAAQMD 2027.",
        "promo_wp_good_comic_4": "4. H? th?ng ho?t d?ng: Nu?c nng dng tin c?y v thn thi?n v?i mi tru?ng.",
        ...
        "promo_wp_better_comic_4": "4. Khch hng t?n hu?ng quy?n ki?m sot ton b? v c?nh bo qua ?ng d?ng.",
        "promo_wp_best_comic_1": "1. nh gib?ng di?n v cc nng c?p c?n thi?t.",
        "promo_wp_best_comic_2": "2. ?t AeroTherm 80 gallon d? d?t cng su?t t?i da.",
        "promo_wp_best_comic_3": "3. B?o v? an?t kp v cng ngh? ho?t d?ng c?c m.",
        "promo_wp_best_comic_4": "4. Tch h?p nh thng minh t?i da v tang gitr? ti s?n.",
        "law_title": "Quy d?nh BAAQMD & M L?p d?t",
        "law_subtitle": "Hu?ng d?n t?i uu v? l?nh Zero-NOx 2027 cho Khu v?c V?nh, cc lo?i my nu?c nng m?i, v cc yu c?u l?p d?t nghim ng?t c?a CSLB v Title 24 c?a California.",
        "law_sec1_title": "1. L?nh BAAQMD 2027 (Quy d?nh 9, Quy t?c 6)",
        "law_sec1_p1": "Qu?n Qu?n l Ch?t lu?ng Khng khKhu v?c V?nh (BAAQMD) d ban hnh m?t s?a d?i l?ch s? d? gi?m  nhi?m nito oxit (NOx).",
        "law_sec1_p2": "<strong>i?u ny c nghia g?</strong> B?t d?u t? ngy 1 thng 1 nam 2027, vi?c bn ho?c l?p d?t my nu?c nng dn d?ng ch?y b?ng khd?t t? nhin m?i pht th?i NOx s? l b?t h?p php. i?u ny cnghia l lo?i b? hon ton cc my nu?c nng b?ng khd?t truy?n th?ng ? Khu v?c V?nh.",
        "law_sec1_li1": "<strong>Tc d?ng T?c th:</strong> Cc thay th? kh?n c?p sau nam 2027 s? yu c?u thi?t b? di?n khng pht th?i d?c quy?n.",
        "law_sec1_li2": "<strong>Chuy?n d?i:</strong> Ch? nh du?c khuy?n co nn chuy?n sang my nu?c nng Bom nhi?t (Heat Pump) tru?c khi c?n ki?t hng t?n kho vo nam 2027.",
        "law_sec2_title": "2. Cc lo?i My nu?c nng (Chuy?n d?i i?n)",
        "law_sec2_p1": "Vi?c hi?u cc cng ngh? du?c ph duy?t cho qutrnh chuy?n d?i nang lu?ng c?a California l r?t quan tr?ng d? tun th? Title 24.",
        "law_sec2_li1": "<strong>Bom nhi?t H?n h?p (Heat Pump):</strong> Trch xu?t nhi?t t? khng khxung quanh d? lm nng nu?c, d?t hi?u su?t trn 300%. y l ty ch?n s? 1 theo yu c?u c?a ti?u bang v d? di?u ki?n nh?n cc kho?n hon tr? t?i da.",
        "law_sec2_li2": "<strong>Bnh i?n Tiu chu?n:</strong> S? d?ng cc ph?n t? nhi?t, km hi?u qu? hon v thu?ng b? ph?t theo cc tnh ton nghim ng?t c?a Title 24, nhung du?c php.",
        "law_sec2_li3": "<strong>i?n Khng bnh ch?a (Tankless):</strong> Lm nng nu?c ngay l?p t?c. M?c d chng khng pht th?i NOx, chng c?n cu?ng d? dng di?n c?c l?n (thu?ng l b?ng di?u khi?n 200A+) v hi?m khi kh? thi n?u khng nng c?p di?n t?n km.",
        "law_sec3_title": "3. Thng s? k? thu?t c?a M (CSLB & Title 24)",
        "law_sec3_p1": "L?p d?t my nu?c nng khng ch? l n?i du?ng ?ng nu?c. Morales Plumbing d?m b?o tun th? nghim ng?t M H? th?ng ?ng nu?c Th?ng nh?t (UPC) c?a California:",
        "law_sec3_li1": "<strong>Dy deo ch?ng ?ng d?t (Earthquake Straps):</strong> Lu?t California yu c?u s? d?ng dy deo di ? m?t ph?n ba trn v du?i, du?c neo tr?c ti?p vo dinh tn tu?ng d? trnh l?t khi cd?ng d?t.",
        "law_sec3_li2": "<strong>Bnh Gin n? Nhi?t:</strong> B?t bu?c d?i v?i cc h? th?ng ?ng nu?c kn d? h?p th? p su?t du th?a, b?o v? du?ng ?ng trong nh v ngan ng?a n? van.",
        "law_sec3_li3": "<strong>Khay thot nu?c (Drain Pan):</strong> B?t bu?c n?u my nu?c nng n?m trn n?n t?ng trong nh, gc mi ho?c khng gian m s? r r? cth? gy hu h?i c?u trc. Khay ph?i c?ng d?n nu?c ra ngoi tr?i.",
        "law_sec3_li4": "<strong>Van T&P (Van x? Nhi?t d? & p su?t):</strong> Quan tr?ng d?i v?i an ton, du?ng x? c?a nph?i d?n nu?c nng d?n c?ng m?t cch an ton, thu?ng l ngoi tr?i.",
        ...
        "nav_back_pb": " Quay l?i B?ng gi",
        "pb_btn_comic_repipe": "Xem Hu?ng d?n T?ng bu?c CHnh minh h?a",
        "pb_btn_comic_coming_soon": "Hu?ng d?n CHnh minh h?a (S?p c)",
        "pb_svc_1_title": "Service 1",
        "pb_svc_1_good_just": "[Scope] Standard leak detection for up to 1 location (under 2,000 sq ft). Includes basic acoustic scanning and visible plumbing inspection. Excludes slab penetrations.",
        "pb_svc_1_good_mat": "Non-toxic tracer dye, basic acoustic mapping chalk, temporary patch materials.",
        "pb_svc_1_good_tools": "Standard acoustic listening discs, moisture meters, manifold gauge set.",
        ...
        "footer_screen_watermark": "MORALES PLUMBING  2026  TI S?N TR TU? U?C B?O V?",
        "footer_print_copyright": "&#9400; B?n quy?n 2026 Morales Plumbing  M?i quy?n du?c b?o luu  Ti s?n trtu? c?a Alex Espinosa  Thuong hi?u d dang k. C?m sao chp ton b? ho?c m?t ph?n m khng cs? cho php b?ng van b?n. San Jose, CA  moralesplumbing.com",
        "footer_print_watermark": " MORALES PLUMBING 2026",
        "faq100_q_1": "T?i sao di?u quan tr?ng l duy tr p su?t chnh xc trong ti s?n?",
        ...
        "faq100_a_2": "Ntc d?ng qunhi?u l?c ln van v cc m?i n?i, lm gi?m tu?i th? s? d?ng c?a chng v tang nguy co n? du?ng ?ng.",
        "faq100_q_3": "Lm th? no ti cth? bi?t du?c p l?c nu?c trong nh mnh l bao nhiu?",
        "faq100_a_3": "K?t n?i d?ng h? do p su?t nu?c v?i y?m ?ng bn ngoi d? ck?t qu? chnh xc.",
        "faq100_q_4": "Van gi?m p (PRV) l g?",
        "faq100_a_4": "L thi?t b? n?m trong du?ng dy chnh ctc d?ng gi?m p su?t cao d?u vo xu?ng m?c an ton.",
        "faq100_q_5": "T?i sao d?t nhin p l?c nu?c trong nh ti th?p?",
        "faq100_a_5": "cth? l do PRV b? l?i, r r? ?n ho?c cv?n d? trong ngu?n cung c?p chnh c?a thnh ph?.",
        "faq100_q_6": "T?i sao ti ch? th?y p l?c nu?c th?p ? m?t vi?",
        "faq100_a_6": "Nguyn nhn thu?ng l do thi?t b? s?c khb? t?c khong ch?t ho?c h?p m?c trong vi db? l?i.",
        "faq100_q_7": "Cn c?nh hu?ng d?n p l?c nu?c khng?",
        "faq100_a_7": "C, hi?n tu?ng vi ha bn trong du?ng ?ng lm gi?m du?ng knh trong, h?n ch? dng nu?c.",
        "faq100_q_8": "Lm cch no d? c?i thi?n p l?c nu?c khi t?m?",
        "faq100_a_8": "Lm s?ch d?u vi hoa sen b?ng gi?m d? lo?i b? c?n ho?c ki?m tra van gi?m p.",
        "faq100_q_9": "My nu?c nng b? l?i cth? gi?m p su?t khng?",
        "faq100_a_9": "C, s? tch t? tr?m tch ho?c van b? an mn cth? h?n ch? dng nu?c nng.",
        "faq100_q_10": "Ti nn ki?m tra p l?c nu?c trong nh bao lu m?t l?n?",
        "faq100_a_10": "Nn ki?m tra t nh?t m?i nam m?t l?n ho?c n?u b?n nh?n th?y nh?ng thay d?i trong quy trnh.",
        "faq100_q_11": "My nu?c nng truy?n th?ng ctu?i th? bao lu?",
        "faq100_a_11": "Ko di trung bnh t? 8 d?n 12 nam, ty thu?c vo m?c d? b?o tr v d? c?ng c?a nu?c.",
        "faq100_q_12": "Uu di?m c?a my su?i khng bnh ch?a l g?",
        "faq100_a_12": "Chng cung c?p nu?c nng khng gi?i h?n, ti?t ki?m nang lu?ng hon v ctu?i th? ln d?n 20 nam.",
        "faq100_q_13": "T?i sao nu?c nng ch?y ra cmu r? st?",
        "faq100_a_13": "Ncho th?y bn trong bnh dang b? r? st v c?n du?c thay th? s?m.",
        "faq100_q_14": "Thanh anode l g v t?i sao nquan tr?ng?",
        "faq100_a_14": "Nl m?t thanh hi?n t? thu ht cc khong ch?t an mn d? b?o v? b? kim lo?i.",
        "faq100_q_15": "T?i sao my su?i c?a ti pht ra ti?ng ku r?c r?c ho?c tanh tch?",
        "faq100_a_15": "Ti?ng ?n l do c?n l?ng ? dy b? si ln khi nu?c nng ln.",
        "faq100_q_16": "Ti nn d?t my nu?c nng ? nhi?t d? no?",
        "faq100_a_16": "Nn d?t ? nhi?t d? 120F (49C) d? trnh b? b?ng v ti?t ki?m nang lu?ng.",
        "faq100_q_17": "My nu?c nng cc?n ph?i x? nu?c hng nam khng?",
        "faq100_a_17": "C, vi?c x? nu?c b? hng nam s? lo?i b? c?n v ko di tu?i th? c?a thi?t b?.",
        "faq100_q_18": "T?i sao ti h?t nu?c nng nhanh nhu v?y?",
        "faq100_a_18": "Ncth? l ?ng nhng b? h?ng, c?n du th?a ho?c cc b? ph?n b? l?i.",
        "faq100_q_19": "My su?i khng bnh ch?a c?n b?o tr nh?ng g?",
        "faq100_a_19": "C?n t?y c?n hng nam b?ng gi?m tr?ng d? lm s?ch b? trao d?i nhi?t.",
        "faq100_q_20": "Van gi?m p (T&P) b? r r? cbnh thu?ng khng?",
        "faq100_a_20": "Khng, di?u dcnghia l p su?t bn trong qucao ho?c van b? l?i.",
        "faq100_q_21": "Lm th? no d? bi?t li?u ti cb? r r? nu?c ?n hay khng?",
        ...
        "faq100_q_24": "Nguyn nhn gy r r? l? kim trong d?ng?",
        "faq100_a_24": "Nu?c c?ng, v?n t?c nu?c cao ho?c cloramin trong ngu?n cung c?p c?a thnh ph?.",
        "faq100_q_25": "'Ba nu?c' l g v cch gi?i quy?t nhu th? no?",
        "faq100_a_25": "Hi?n tu?ng ?n khi dng vi du?c gi?i quy?t b?ng cch l?p gi?m ch?n ba nu?c.",
        "faq100_q_26": "Ti cnn thay th? ?ng thp m? k?m c?a mnh khng?",
        "faq100_a_26": "C, chng b? r? st bn trong gy r r?, nu?c b?n v p su?t th?p.",
        "faq100_q_27": "Repipe l g?",
        "faq100_a_27": "l thay th? ton b? h? th?ng phn ph?i nu?c cu b?ng d?ng lo?i L ho?c PEX.",
        "faq100_q_28": "Lm th? no d? b?o v? du?ng ?ng kh?i b? dng bang?",
        "faq100_a_28": "Cch nhi?t cc du?ng ?ng h? v d? l?i m?t cht nh? gi?t vo nh?ng dm l?nh gi.",
        "faq100_q_29": "V sao nu?c cmi tr?ng th?i?",
        "faq100_a_29": "Vi khu?n luu hu?nh trong h? th?ng thot nu?c nng ho?c kh (b?y ch? P khng dng nu?c).",
        "faq100_q_30": "Van ng?t chnh ? du?",
        "faq100_a_30": "Nthu?ng ? g?n d?ng h? trn du?ng ho?c noi du?ng ?ng chnh d?n vo nh.",
        "faq100_q_31": "T?i sao c?ng c?a ti cmi hi?",
        "faq100_a_31": "Nx?y ra n?u nu?c trong b?y 'P' bay hoi, t?o di?u ki?n cho khxm nh?p.",
        "faq100_q_32": "Nguyn nhn gy ra r? c?ng?",
        "faq100_a_32": "R? xuyn qua cc du?ng ?ng cu qua cc v?t n?t nh? d? tm nu?c v ch?t dinh du?ng.",
        "faq100_q_33": "Lm th? no d? ngan ng?a t?c ngh?n c?ng?",
        "faq100_a_33": "Khng d? d?u m? ho?c khan u?t v s? d?ng d?ng c? l?c tc.",
        "faq100_q_34": "S? d?ng ha ch?t thng c?ng can ton khng?",
        "faq100_a_34": "Khng, chng t?o ra nhi?t d? cao lm an mn v lm h?ng cc ?ng nh?a v kim lo?i cu.",
        "faq100_q_35": "Ki?m tra camera l g?",
        "faq100_a_35": "Ns? d?ng s?i quang d? ch?n don cc v?n d? du?i lng d?t m khng c?n ph?i do.",
        "faq100_q_36": "S?a ch?a 'khng rnh' nghia l g?",
        "faq100_a_36": "l thay th? du?ng c?ng ng?m m khng do rnh ngang ton b? sn.",
        "faq100_q_37": "T?i sao b?n c?u l?i n?i bong bng khi t?m?",
        "faq100_a_37": "Cho bi?t cv?n d? nghim tr?ng v? thng giho?c t?c ngh?n trong du?ng ?ng chnh.",
        "faq100_q_38": "Van nu?c ngu?c l g?",
        "faq100_a_38": "Ngan ch?n nu?c th?i thnh ph? ch?y ngu?c vo nh khi lu l?t.",
        "faq100_q_39": "Ti nn th?c hi?n phun th?y l?c bao lu m?t l?n?",
        "faq100_a_39": "?nh k? 1 d?n 3 nam ph?i lm s?ch hon ton d?u m? v r? bm trn thnh ?ng.",
        "faq100_q_40": "S? khc bi?t gi?a r?n v phun nu?c?",
        "faq100_a_40": "Con r?n ch?c th?ng v?t c?n, phun th?y l?c r?a du?ng ?ng du?i p l?c, khi?n du?ng ?ng tr? nn nhu m?i.",
        "faq100_q_41": "T?i sao nh v? sinh lin t?c ch?y?",
        "faq100_a_41": "y thu?ng l m?t ci n?p b? mn, khng b?t kn dng cch ho?c van n?p b? l?i.",
        "faq100_q_42": "Lng phbao nhiu nu?c khi b?n c?u b? r r??",
        "faq100_a_42": "B?n cth? lng pht?i 200 gallon m?i ngy, lm tang dng k? ha don c?a b?n.",
        "faq100_q_43": "V sao b?n c?u thu?ng xuyn b? t?c?",
        "faq100_a_43": "B?ng nh?ng b?n c?u cu, t dng ch?y, ho?c v?t b? khan u?t v gi?y th?a.",
        "faq100_q_44": "Khan lau cth? x? du?c clm t?c b?n c?u khng?",
        "faq100_a_44": "C, chng khng phn h?y nhu gi?y v gy t?c ngh?n nghim tr?ng trong h? th?ng.",
        "faq100_q_45": "? ?m xung quanh chn b?n c?u?",
        "faq100_a_45": "Vng sp bn du?i d h?ng v c?n thay th? d? trnh lm sn b? m?c nt.",
        "faq100_q_46": "Lm th? no d? kh?c ph?c vi hoa sen b? r r??",
        "faq100_a_46": "Thay h?p m?c bn trong ho?c gioang cao su b? mn pha sau tay c?m.",
        "faq100_q_47": "T?i sao ct p l?c khi t?m m khng cp su?t trong b?n r?a?",
        "faq100_a_47": "?u vi hoa sen thu?ng cb? h?n ch? kha khong.",
        "faq100_q_48": "L? trn trong b?n r?a d? lm g?",
        "faq100_a_48": "Ngan ch?n nu?c trn n?u b?n qun dng vi v gip thot nu?c.",
        "faq100_q_49": "i?u g s? x?y ra n?u th? g dcgitr? roi xu?ng b?n r?a?",
        "faq100_a_49": "T?t nu?c, tho b?y 'P' du?i b?n r?a v l?y n? d.",
        "faq100_q_50": "Nh v? sinh ctu?i th? bao lu?",
        "faq100_a_50": "? s? hng ch?c nam nhung linh ki?n bn trong nn du?c thay th? sau m?i 5 d?n 7 nam.",
        "faq100_q_51": "T?i sao thng rc c?a ti ku vo vo v khng quay?",
        "faq100_a_51": "Nb? k?t. S? d?ng c? l Allen ? pha du?i d? xoay v m? kha theo cch th? cng.",
        "faq100_q_52": "Nh?ng g KHNG nn b? vo thng rc?",
        "faq100_a_52": "Ch?t bo, d?u, xuong, c?n ty, v? khoai ty, m ?ng ho?c g?o.",
        "faq100_q_53": "Lm th? no d? lo?i b? mi hi t? vi?c x? l?",
        "faq100_a_53": "Nghi?n dvin v v? cam qut b?ng nu?c l?nh d? lm s?ch.",
        "faq100_q_54": "Nn s? d?ng nu?c nng hay nu?c l?nh khi x? l?",
        "faq100_a_54": "Lun d? ngu?i d? m? dng d?c l?i v cth? nghi?n nt m khng b? dnh.",
        "faq100_q_55": "Vi b?p p su?t th?p?",
        "faq100_a_55": "Tho thi?t b? s?c kh? d?u v lm s?ch c?n khong.",
        "faq100_q_56": "Nu?c d?ng trong my r?a chn?",
        "faq100_a_56": "B? l?c b?n ho?c ?ng thot nu?c b? t?c.",
        "faq100_q_57": "Vi ch?y nh? gi?t khi dng?",
        "faq100_a_57": "B?n c?n thay h?p g?m ho?c mi?ng d?m bn trong b? mn.",
        "faq100_q_58": "'Kho?ng tr?ng khng kh' bn c?nh vi l g?",
        "faq100_a_58": "Ngan ch?n nu?c b?n ch?y ngu?c vo my r?a bt.",
        "faq100_q_59": "Ph?i lm g n?u du?ng ?ng b? v? du?i b?n r?a?",
        "faq100_a_59": "ng ngay cc van ng?t bn du?i ho?c van chnh trong nh.",
        "faq100_q_60": "B?n r?a di ch?i nu?c ? pha bn kia khng?",
        "faq100_a_60": "T?c ngh?n trong du?ng ?ng chnh bn du?i kh?p ch? 'T'. C?n cm?t con r?n.",
        "faq100_q_61": "Nu?c c?ng l g?",
        "faq100_a_61": "Nu?c chm lu?ng canxi v magie cao gy dng c?n v lm h?ng h? th?ng ?ng nu?c.",
        "faq100_q_62": "Khi no ti c?n lm m?m nu?c?",
        "faq100_a_62": "N?u b?n cd?m tr?ng, da kh v my su?i c?a b?n nhanh chng b? hu h?ng do c?n.",
        "faq100_q_63": "S? khc bi?t gi?a ch?t lm m?m v b? l?c?",
        "faq100_a_63": "Ch?t lm m?m lo?i b? canxi (s? d?ng mu?i). B? l?c lo?i b? clo, ha ch?t v mi v? khch?u (s? d?ng carbon).",
        "faq100_q_64": "Th?m th?u ngu?c (RO) l g?",
        "faq100_a_64": "L?c ? c?p d? phn t?, lo?i b? 99% ch?t gy  nhi?m d? cnu?c u?ng r?t tinh khi?t.",
        "faq100_q_65": "Bao lu th ph?i thay b? l?c nu?c?",
        "faq100_a_65": "Carbon 6 thng/l?n, mng RO 2-3 nam/l?n ty theo m?c dch s? d?ng.",
        "faq100_q_66": "D?u x? khng ch?a mu?i chi?u qu? khng?",
        "faq100_a_66": "Chng ngan ch?n s? tch t? c?n trong du?ng ?ng nhung khng lo?i b? canxi kh?i nu?c m?t cch v?t l.",
        "faq100_q_67": "Nu?c my cmu tr?ng d?c ho?c tr?ng d?c?",
        "faq100_a_67": "Chng l nh?ng bong bng khsiu nh? v h?i. N?u r?a t? du?i ln th khng nguy hi?m.",
        "faq100_q_68": "Cloramin l g?",
        "faq100_a_68": "Ch?t kh? trng thnh ph? an mn du?ng ?ng cu v c?n cb? l?c d?c bi?t d? lo?i b? chng.",
        "faq100_q_69": "Clo clm h?ng ?ng PEX khng?",
        "faq100_a_69": "? nhi?t d? cao th c. B? l?c ton b? ngi nh gip ko di tu?i th? c?a h? th?ng PEX.",
        "faq100_q_70": "U?ng nu?c my can ton khng?",
        "faq100_a_70": "Ni chung l c, nhung du?ng ?ng cu cth? thm kim lo?i vo. M?t b? l?c nh b?p r?t du?c khuy?n khch.",
        "faq100_q_71": "? nh c?n cnh?ng d?ng c? g?",
        "faq100_a_71": "Pt tng, bang Teflon, c? l di?u ch?nh v c? l ?ng nh?.",
        "faq100_q_72": "T?i sao bi?t van ch?n ? du?",
        "faq100_a_72": "? t?t nu?c trong tru?ng h?p kh?n c?p v ngan ch?n thi?t h?i do lu l?t hng ngn d la.",
        "faq100_q_73": "Lm g tru?c k? ngh? di?",
        "faq100_a_73": "T?t van nu?c chnh v d?t my su?i ? ch? d? 'Ngh? php'.",
        "faq100_q_74": "B?y m? l g?",
        "faq100_a_74": "B?y d?u m? tru?c khi l?t vo c?ng; B?t bu?c trong b?p an thuong m?i.",
        "faq100_q_75": "Lm th? no d? pht hi?n r r? im l?ng trong nh v? sinh?",
        "faq100_a_75": "Cho thu?c nhu?m vo b?; N?u nxu?t hi?n trong c?c m khng x? trong vng 15 pht th cnghia l cr r?.",
        "faq100_q_76": "Cc?n thi?t ph?i lm s?ch mng x?i trn mi nh khng?",
        "faq100_a_76": "C, chng ngan nu?c trn lm hu h?ng n?n mng v du?ng thot nu?c c?a Php.",
        "faq100_q_77": "Cnn ki?m tra ?ng m?m my gi?t?",
        "faq100_a_77": "C, thay ?ng cao su b?ng thp b?n 5 nam m?t l?n s? ngan ng?a lu l?t nghim tr?ng.",
        "faq100_q_78": "Lm th? no d? ngan ch?n vi ngoi tr?i b? dng bang?",
        "faq100_a_78": "Ng?t k?t n?i vo ma dng ho?c l?p cc van khng dng bang khng gi? nu?c.",
        ...
        "faq100_a_80": "Lm s?ch cc m?nh v?n hng nam v d? nu?c d? xc minh r?ng nt? kch ho?t.",
        ...
        "faq100_q_82": "Ph?i lm g n?u du?ng ?ng b? v??",
        "faq100_a_82": "1. ng van chnh. 2. T?t ngu?n di?n g?n d. 3. G?i th? s?a ?ng nu?c.",
        "faq100_q_83": "B?n cng?i th?y mi gas khng?",
        "faq100_a_83": "So tn, khng b?t dn ho?c di?n tho?i di d?ng v g?i PG&E ho?c tru?ng h?p kh?n c?p (911).",
        "faq100_q_84": "Nu?c cdu?c tr? l?i m?i l?n t?m khi s? d?ng my gi?t khng?",
        "faq100_a_84": "T?c ngh?n ton b? du?ng c?ng chnh. Vi?c phun th?y l?c l r?t c?n thi?t.",
        "faq100_q_85": "Ph?i lm g n?u my su?i b? ng?p nu?c?",
        "faq100_a_85": "ng van nu?c l?nh c?a bnh ch?a v c?t ngu?n cung c?p gas ho?c di?n cho thi?t b?.",
        "faq100_q_86": "B?o hi?m cchi tr? cho vi?c v? ?ng khng?",
        "faq100_a_86": "Nthu?ng bao g?m nh?ng hu h?ng khng lu?ng tru?c du?c do nu?c gy ra cho k?t c?u, nhung khng bao g?m vi?c s?a ch?a du?ng ?ng.",
        "faq100_q_87": "Lm th? no d? gi?m thi?u thi?t h?i do nu?c nhanh chng?",
        "faq100_a_87": "Dng khan t?m, m? c?a s?, b?t qu?t, di chuy?n d? d?c b?ng g? v thi?t b? di?n t?.",
        "faq100_q_88": "B?t trt epoxy cho?t d?ng khng?",
        "faq100_a_88": "C, nhung ch? l b?n vt?m th?i. S? rung d?ng ho?c p l?c cu?i cng s? phv? nm?t l?n n?a.",
        "faq100_q_89": "T? s?a ch?a du?ng ?ng d?n kh?",
        "faq100_a_89": "C?c k? nguy hi?m v b?t h?p php ? California n?u khng cgi?y php CSLB.",
        "faq100_q_90": "ang ch?n v?n d? c?a ti ho?c c?a thnh ph??",
        "faq100_a_90": "N?u phch c?m n?m trong ph?m vi ranh gi?i nh c?a b?n, b?n ph?i ch?u trch nhi?m s?a ch?a.",
        "faq100_q_91": "H? th?ng nu?c thng minh l g?",
        "faq100_a_91": "Cc van Wi-Fi (nhu Flo by Moen) theo di nu?c v t? ng?t du?ng dy n?u pht hi?n r r?.",
        "faq100_q_92": "S? khc bi?t gi?a lo?i d?ng L v M?",
        "faq100_a_92": "Lo?i L dy dng cho m?c dch thuong m?i du?i lng d?t. Lo?i M m?ng, s? d?ng nh? nhng trong nh.",
        "faq100_q_93": "T?i sao h? c?m hn ch?",
        "faq100_a_93": "Ch l ch?t d?c v lm  nhi?m nu?c u?ng, gy t?n thuong th?n kinh nghim tr?ng.",
        "faq100_q_94": "H? th?ng ProPress l g?",
        "faq100_a_94": "U?n cc ph? ki?n d?ng b?ng th?y l?c, khng c?n ng?n l?a ho?c hn, t?o ra s? b?t kn an ton v ngay l?p t?c.",
        "faq100_q_95": "My bom tu?n hon l g?",
        "faq100_a_95": "Cung c?p nu?c nng ngay l?p t?c cho vi sen m khng c?n ph?i m? nu?c ch? nu?c nng ln.",
        "faq100_q_96": "Ti cth? s? d?ng mua cho nh v? sinh khng?",
        "faq100_a_96": "C, s? d?ng m?ng lu?i du?ng ?ng mu tm v luu v?c mu xm, tun theo cc quy t?c sinh thi nghim ng?t.",
        "faq100_q_97": "T?i sao nh v? sinh m?i c?a ti l?i t nu?c?",
        "faq100_a_97": "Cc tiu chu?n ti?t ki?m nu?c c?a ti?u bang b?t bu?c ph?i s? d?ng cc m hnh dng ch?y th?p, hi?u su?t cao (1,28 GPM).",
        "faq100_q_98": "My su?i lai (Heat Pump) l g?",
        "faq100_a_98": "Ns? d?ng nhi?t d? phng d? lm nng nu?c, hi?u qu? g?p 3 l?n so v?i my ch?y di?n thng thu?ng.",
        "faq100_q_99": "H? th?ng nu?c Morales cnh?ng l?i ch sinh thi no?",
        "faq100_a_99": "Tnh ton chnh xc d? gi?m chi phv?t li?u, ti ch? kim lo?i v tri?n khai cc h? th?ng tiu th? c?c th?p.",
        "faq100_q_100": "T?i sao h? th?ng nu?c Morales?",
        "faq100_a_100": "B?i v chng ti k?t h?p tay ngh? kho lo c?a C-36 d du?c ch?ng nh?n v?i cc phuong php Lean d? l?p d?t li?n m?ch v khng lng ph.",
        "membership_section_title": "Gi h?i vin (H? sinh thi Orion)",
        "membership_section_desc": "Ch?n m?t c?p d? trong H? sinh thi Orion d? ti?p c?n cc kho?n chi?t kh?u gid?c quy?n v d?c quy?n nng cao.",
        "pricing_preview_title": "GI CO B?N U?C TNH",
        "pricing_preview_plan": "K? HO?CH THNH VIN",
        "pricing_preview_total": "T?NG CHI PH U?C TNH",
        "lbl_list_price": "Ginim y?t",
        "lbl_discounted_price": "Gichi?t kh?u theo c?p",
        "lbl_free_trial": "Dng th? mi?n ph",
        "pricing_note_free_trial": "Cu?c g?i Dng th? Mi?n ph(d dng {count} / 5)",
        "pricing_note_free_limit": "Gig?c ( d?t gi?i h?n dng th? mi?n ph)",
        "pricing_note_standard": "C?p Standard:  p d?ng gi?m gi10%",
        "pricing_note_premium": "C?p Premium:  p d?ng gi?m gi20%",
        "pricing_note_select_service": "Vui lng ch?n d?ch v? v c?p d? d? xem tru?c gi.",
        "lbl_membership_badge_free": "MI?N PH",
        "lbl_membership_badge_standard": "STANDARD",
        "lbl_membership_badge_premium": "PREMIUM",
        "btn_upgrade": "Nng c?p",
        "btn_active_plan": "K? ho?ch Hi?n t?i",
        "usage_tracker_text": "S? cu?c g?i mi?n phd dng: {used} / 5",
        "msg_membership_updated": "Thnh vin d c?p nh?t thnh {tier}",
        "portal_title": "C?NG THNG TIN KHCH HNG MP",
        "portal_subtitle": "Qu?n l thng minh L?ch h?n, PQR v B? nh? d?ch v?",
        "tab_dashboard": " B?ng di?u khi?n",
        "tab_schedule": " ?t l?ch h?n",
        "tab_pqr": " G?i PQR",
        "tab_profile": " H? so / B? nh? c?a ti",
        "tab_policies": "? Chnh sch",
        "dash_welcome": "Cho m?ng d?n v?i H? sinh thi c?a b?n",
        "dash_intro": "T?i dy b?n cth? xem tr?ng thi l?ch h?n, bo co v yu c?u dang ho?t d?ng.",
        "dash_active_appointments": " L?ch h?n d d?t",
        "dash_active_pqrs": " Yu c?u PQR",
        "dash_feedback_title": "? nh gi& Ph?n h?i D?ch v?",
        "dash_feedback_desc": " ki?n c?a b?n s? gip chng ti hon thi?n Joe AI v nng cao ch?t lu?ng k? thu?t.",
        ...
        "lbl_select_service": "D?CH V? YU C?U",
        "lbl_select_tier": "C?P ? D?CH V? (PRICE BOOK)",
        "lbl_tier_good": "GOOD (Tiu chu?n)",
        "lbl_tier_better": "BETTER (Cao c?p)",
        "lbl_tier_best": "BEST (T?i uu)",
        "lbl_select_date": "NGY",
        "lbl_select_time": "GI?",
        "btn_confirm_appointment": "Xc nh?n l?ch h?n k? thu?t",
        "pqr_title": "Trung tm PQRS (Yu c?u, Khi?u n?i, Th?c m?c & Gp )",
        "pqr_desc": "ang k khi?u n?i, gp  ho?c yu c?u tr?c ti?p. M?i tru?ng h?p du?c x? l theo quy trnh nghim ng?t.",
        "lbl_pqr_type": "LO?I YU C?U",
        "pqr_opt_request": "Yu c?u (Yu c?u d?c bi?t)",
        "pqr_opt_complaint": "Khi?u n?i (Khng hi lng d?ch v?)",
        "pqr_opt_claim": "Th?c m?c (L?i l?p d?t/B?o hnh)",
        "pqr_opt_suggestion": "Gp  (C?i ti?n)",
        "lbl_pqr_desc": "M T? CHI TI?T",
        "btn_submit_pqr": "G?i yu c?u",
        "profile_title": "B? nh? danh tnh khch hng",
        "profile_desc": "Luu thng tin cnhn d? kch ho?t b? nh? di h?n c?a Joe AI. Ton b? thng tin du?c luu tr? c?c b? an ton.",
        "lbl_profile_name": "H? V TN",
        ...
        "pol_quality_title": "? ?M B?O CH?T LU?NG & B?O TR D? PHNG",
        "pol_quality_text": "Chng ti d?m b?o ch?t lu?ng l?p d?t v d?ch v? cao nh?t b?ng quy trnh ki?m tra kp nghim ng?t. ? b?o d?m d? b?n lu di c?a h? th?ng, Morales Plumbing cung c?p cho h?i vin Tiu chu?n 1 l?n ki?m tra b?o tr d? phng mi?n phhng nam (d r r? ho?c s?c r?a bnh nng l?nh) v h?i vin Cao c?p nh?n du?c 2 l?n ki?m tra b?o tr d? phng mi?n phhng nam (n?i soi SeeSnake, ki?m tra ha h?c nu?c, hi?u chu?n van PRV ho?c d nhi?t r r?). T?t c? cng vi?c d?u tun th? B? lu?t Plumbing Th?ng nh?t (UPC).",
        "pol_sec_title": " AN NINH NU?C & TUN TH? CSLB",
        "pol_sec_text": "M?i ho?t d?ng c?a Morales Plumbing du?c qu?n l b?i California Contractors State License Board (CSLB #1156542 C-36). Chng ti th?c hi?n quy trnh ki?m tra kp nghim ng?t v tun th? UPC.",
        "pol_priv_title": "? B?O M?T E2EE & KHNG TI?T L?",
        "pol_priv_text": "Quy?n ring tu c?a b?n l tuy?t d?i. H? th?ng s? d?ng luu tr? c?c b? (LocalStorage). Thng tin lin h?, d?a ch? v l?ch h?n c?a b?n khng bao gi? du?c g?i d?n bn th? ba.",
        "pol_copy_title": "? B?N QUY?N & S? H?U TR TU?",
        "pol_copy_text": "N?i dung k? thu?t c?a 'ORION Price Book v6.0 PRO', ti li?u 'Estimator Pro', so d? th?y l?c CAD v ORION Podcasts l ti s?n trtu? d?c quy?n c?a Morales Plumbing.",
        "tier_free_title": "Mi?n ph<span class=\"membership-status-badge badge-free\">FREE</span>",
        "tier_free_desc": "L tu?ng cho khch hng m?i. Bao g?m t?i da 5 l?ch h?n d?ch v? v?i $0 phg?i ban d?u.",
        "tier_standard_title": "Tiu chu?n <span class=\"membership-status-badge badge-standard\">STANDARD</span>",
        "tier_standard_desc": "Dnh cho b?o du?ng d?nh k?. ?t l?ch khng gi?i h?n, gi?m gitr?c ti?p 10%, v 1 l?n Ki?m tra D? phng Hng nam Mi?n ph(d r r? ho?c s?c r?a bnh nng l?nh).",
        "tier_premium_title": "Premium <span class=\"membership-status-badge badge-premium\">PREMIUM</span>",
        "tier_premium_desc": "B?o hi?m ton di?n. Uu tin d?t l?ch khng gi?i h?n, gi?m tr?c ti?p 20%, h? tr? uu tin, v 2 l?n Ki?m tra D? phng Hng nam Mi?n ph(n?i soi SeeSnake, ki?m tra ha h?c nu?c, ho?c hi?u chu?n van PRV).",
        "btn_activate": "Kch ho?t",
        "maint_title": "? H? th?ng b?o tr d? phng",
        "maint_free": "Khng bao g?m ki?m tra b?o tr d? phng trong gi Mi?n ph. Hy nng c?p ln gi Tiu chu?n ho?c Premium d? b?o v? co s? h? t?ng ngi nh c?a b?n.",
        "maint_standard": "? L?i ch Tiu chu?n: 1 l?n Ki?m tra D? phng Hng nam Mi?n ph(d r r? ho?c s?c r?a bnh nng l?nh). ang k qua PQR ho?c ni chuy?n v?i Joe AI d? d?t l?ch.",
        "maint_premium": " L?i ch Cao c?p: 2 l?n Ki?m tra D? phng Hng nam Mi?n ph(n?i soi SeeSnake, ki?m tra ha h?c nu?c, ho?c hi?u chu?n van PRV). ang k qua PQR ho?c ni chuy?n v?i Joe AI d? d?t l?ch.",
        "clear_local_label": "B?n cmu?n thi?t l?p l?i t?t c? ci d?t c?c b? khng?",
        "eng_tech_details": "Chi ti?t k? thu?t",
        "eng_btn_details": "Xem chi ti?t ?",
        "eng_back": " Quay l?i D?ch v? Trung tm",
        "eng_termo_title": "Ch?n don Thermography",
        "eng_termo_code": "ENG-CENT-001",
        "eng_termo_p1": "Ch?n don b?ng Nhi?t d? h?c l m?t tr? c?t co b?n c?a D?ch v? K? thu?t Trung tm c?a chng ti. Nbao g?m vi?c pht hi?n r r? hon ton khng xm l?n b?ng cch s? d?ng hnh ?nh nhi?t d? phn gi?i cao v c?m bi?n m thanh.",
        "eng_termo_p2": "Thay v th?c hi?n cc cng vi?c phd? tham d t?n km v mang tnh h?y ho?i, chng ti s? d?ng cng ngh? h?ng ngo?i FLIR d? hnh dung cc gradient nhi?t bn trong tu?ng v du?i cc t?m b tng.",
        "eng_termo_tech1_title": "Hnh ?nh H?ng ngo?i ? chnh xc Cao",
        "eng_termo_tech1_desc": "My ?nh c?a chng ti ghi l?i s? khc bi?t nhi?t d? ln d?n 0.1C, cho th?y chnh xc noi nu?c r r? di qua.",
        "eng_termo_tech2_title": "Phn tch m thanh My tnh",
        "eng_termo_tech2_desc": "Chng ti s? d?ng micr siu nh?y v?i cc b? l?c AI d? phn bi?t ti?ng ?n xung quanh v?i ti?ng rt do nu?c cp su?t thot ra gy ra.",
        "eng_termo_tech3_title": "L?p B?n d? K? thu?t s? v Bo co",
        "eng_termo_tech3_desc": "Chng ti cung c?p m?t bo co k? thu?t s? ton di?n thng qua c?ng thng tin c?a chng ti, ch?ng minh v?n d? d?i v?i cc yu c?u b?o hi?m v t?o di?u ki?n cho vi?c s?a ch?a chnh xc.",
        "eng_eco_title": "Eco-Retrofitting",
        "eng_eco_code": "ENG-CENT-002",
        "eng_eco_p1": "Eco-Retrofitting l chuyn mn tin ti?n c?a chng ti d? hi?n d?i ha cc h? th?ng th?y l?c hi?n cb?ng v?t li?u thn thi?n v?i mi tru?ng v cc thnh ph?n ti?t ki?m nu?c c?c k? hi?u qu?.",
        "eng_eco_p2": "Chng ti c?p nh?t cc thi?t b? c?a ta nh d? gi?m dng k? lu?ng nu?c tiu th? m khng lm gi?m p su?t ho?c s? tho?i mi.",
        "eng_eco_tech1_title": "Gi?m lu?ng nu?c du?c ch?ng minh",
        "eng_eco_tech1_desc": "L?p d?t b? di?u ch?nh luu lu?ng cs?c kh, nh v? sinh x? kp tiu th? c?c th?p (UHET) v van gi?m p su?t thng minh (PRV).",
        "eng_eco_tech2_title": "V?t li?u B?n v?ng",
        "eng_eco_tech2_desc": "Vi?c s? d?ng d?c quy?n cc ?ng cth? ti ch? ho?c nh?ng ?ng cch?ng nh?n tc d?ng carbon th?p, d?m b?o d? n c?a b?n ctc d?ng mi tru?ng b?ng khng.",
        "eng_eco_tech3_title": "Ch?ng nh?n Ti?t ki?m",
        "eng_eco_tech3_desc": "Chng ti cung c?p cc tnh ton L?i t?c d?u tu (ROI) v ti?t ki?m nu?c du?c b?o d?m (ln d?n 40% hng thng), thch h?p d? dang k cc kho?n gi?m gic?a ti?u bang.",
        "eng_diseno_title": "Thi?t k? Co s? h? t?ng Th?y l?c",
        "eng_diseno_code": "ENG-CENT-003",
        "eng_diseno_p1": "Thi?t k? Co s? h? t?ng Th?y l?c c?a Morales Plumbing l m?t d?ch v? k? thu?t tin ti?n d?m b?o tnh kh? thi, hi?u qu? v kh? nang m? r?ng.",
        "eng_diseno_p2": "Cc k? su c?a chng ti s? d?ng ph?n m?m m hnh 3D v trnh m ph?ng d?ng l?c h?c ch?t l?ng d? tnh ton gradien p su?t, s? gin n? nhi?t v v?n t?c dng ch?y.",
        "eng_diseno_tech1_title": "M hnh BIM Tch h?p",
        "eng_diseno_tech1_desc": "Thi?t k? tham s? tuong thch v?i Autodesk Revit, cho php ph?i h?p hon h?o v?i cc ki?n trc su v nh th?u.",
        "eng_diseno_tech2_title": "M ph?ng Dng ch?y v p su?t",
        "eng_diseno_tech2_desc": "Cc bi ki?m tra p l?c ?o trn m hnh k? thu?t s? d? d?m b?o cung c?p cn b?ng ngay c? trong nh?ng th?i gian nhu c?u cao di?m.",
        "eng_diseno_tech3_title": "Tun th? Quy d?nh (UPC/CPC)",
        "eng_diseno_tech3_desc": "S? ch?p thu?n du?c d?m b?o trong cc cu?c ki?m tra c?a thnh ph? nh? vi?c tun th? nghim ng?t cc Quy d?nh L?p d?t ?ng nu?c Th?ng nh?t v c?a California.",
        "eng_cobre_title": "C?i t?o ?ng C?p cao",
        "eng_cobre_code": "ENG-CENT-004",
        "eng_cobre_p1": "C?i t?o ?ng Elite d?i di?n cho tiu chu?n vng trong co s? h? t?ng th?y l?c. Chng ti thay th? cc h? th?ng du?ng ?ng d l?i th?i b?ng cc ?ng d?ng Lo?i L v Lo?i K cd? tinh khi?t cao.",
        "eng_cobre_p2": "?ng cung c?p d?c tnh khng khu?n t? nhin thanh l?c th? d?ng luu lu?ng nu?c v d?m b?o khng cvi nh?a du?c gi?i phng.",
        "eng_cobre_tech1_title": "Hn Chnh xc v H? th?ng ProPress",
        "eng_cobre_tech1_desc": "Chng ti s? d?ng cc k? thu?t n?i co khkhng ng?n l?a (ProPress) ho?c hn c?p d? hng khng vu tr? khng ch?a ch.",
        "eng_cobre_tech2_title": "Tu?i th? v L?i t?c d?u tu",
        "eng_cobre_tech2_desc": "K? v?ng tu?i th? hon 50 nam. Ngay l?p t?c nng cao gitr? c?u trc c?a ti s?n ln d?n 15%.",
        "eng_cobre_tech3_title": "Ch?t lu?ng m thanh v Dng ch?y ?n d?nh",
        "eng_cobre_tech3_desc": "? dy c?a thnh ?ng d?ng Lo?i L lo?i b? ba nu?c v ch?u du?c p su?t c?c cao.",
        "eng_septico_title": "K? thu?t H?m t? ho?i Tin ti?n",
        "eng_septico_code": "ENG-CENT-005",
        "eng_septico_p1": "B? ph?n K? thu?t H?m t? ho?i Tin ti?n c?a chng ti thi?t k?, tri?n khai v b?o tr cc h? th?ng qu?n l nu?c th?i khng k?t n?i lu?i di?n b?ng cng ngh? sinh h?c hi?n d?i.",
        "eng_septico_p2": "Thay v l?p d?t cc b? ph?t thng thu?ng, chng ti p d?ng cc on v? X? l Hi?u kh(ATU) x? l nu?c d?n d? tinh khi?t g?n nhu ph h?p d? tu?i b? m?t.",
        "eng_septico_tech1_title": "Nghin c?u Th?m qua v Thi?t k? ?a hnh",
        "eng_septico_tech1_desc": "nh gid?a ch?t c?a d?a hnh d? xc d?nh t?c d? h?p th? chnh xc v d?nh c? khu v?c l?c muong.",
        "eng_septico_tech2_title": "Tch h?p L ph?n ?ng Sinh h?c",
        "eng_septico_tech2_desc": "Trang b? cc h? th?ng s?c khlm tang t?c d? phn h?y ch?t r?n theo c?p s? nhn thng qua cc vi khu?n hi?u khc?c k? hi?u qu?.",
        "eng_septico_tech3_title": "Tun th? Quy d?nh",
        "eng_septico_tech3_desc": "Qu?n l gi?y php t? d?u d?n cu?i, d?m b?o thi?t k? vu?t qua cc yu c?u v? s?c kh?e v gi?m b?t cc kho?n ti?n ph?t.",
        "faq_title": "Q&A | Trung tm K? thu?t",
        "faq_cat_plumbing": "H? th?ng du?ng ?ng",
        "faq_cat_eco": "H? sinh thi Eco-Plumbing & Lean",
        "faq_cat_env": "Quy d?nh Mi tru?ng 2026",
        "faq_q1": "T?i sao ch?n ?ng d?ng thay v PEX khi c?i t?o v xy d?ng m?i?",
        "faq_a1": "?ng cung c?p d? b?n vu?t tr?i, kh? nang ch?ng chy v ngan ng?a vi khu?n pht tri?n. Theo UPC California, nv?n l tiu chu?n vng cho gitr? cao c?p. M?t khc, PEX mang l?i s? linh ho?t vu?t tr?i, t m?i n?i hon (gi?m thi?u di?m r r?), th?i gian l?p d?t nhanh hon v chi phv?t li?u ban d?u th?p hon. <span class=\"comic-choice\">Quy?t d?nh l c?a b?n</span>: ch?n d? b?n cao c?p v gitr? v?t li?u c? di?n (?ng), ho?c hi?u qu? chi phhi?n d?i v kh? nang ph?c h?i dn h?i (PEX).",
        "faq_q2": "Cc quy d?nh v? b? t? ho?i v mi tru?ng nam 2026 c?a California l g?",
        "faq_a2": "Cc quy d?nh t?p trung vo gi?m nito, b?o v? nu?c ng?m v hi?u qu? ti s? d?ng nu?c. Morales Plumbing d?m b?o tun th? 100% thng qua k? thu?t mi tru?ng tin ti?n v cc giao th?c c?a Ban Nu?c. Ngoi ra, chng ti thi?t k? cc h? th?ng b? t? ho?i tun th? tiu chu?n gip gi?m thi?u chi phban d?u b?ng cc l? trnh c?p php truy?n th?ng. <span class=\"comic-choice\">Quy?t d?nh l c?a b?n</span>: d?u tu vo h? sinh thi tin ti?n d? dn d?u tiu chu?n 2030, ho?c ch?n c?u hnh tiu chu?n t?p trung vo ti?t ki?m chi phtru?c m?t.",
        "faq_q3": "Quy trnh Lean v K? thu?t Mi tru?ng cl?i g cho d? n c?a ti?",
        "faq_a3": "B?ng cch lo?i b? lng phv s? d?ng v?t li?u b?n v?ng, chng ti gi?m 25% chi phv 30% th?i gian th?c hi?n. Cc giao th?c c?a chng ti d?m b?o lu?ng khth?i carbon th?p hon v ROI co s? h? t?ng cao hon. Ho?c chng ti cung c?p cc phuong php xy d?ng c? di?n t?p trung vo d?c di?m ty ch?nh t?i da v d? phng c?u trc th? cng tuy?t d?i m khng b? gi?i h?n ti?n d? Lean. <span class=\"comic-choice\">Quy?t d?nh l c?a b?n</span>: ch?n quy trnh Lean sinh thi tang t?c d? t?i da ha hi?u qu?, ho?c xy d?ng th? cng c? di?n d? cbin d? ty ch?nh truy?n th?ng.",
        "faq_q4": "Ti cth? tch h?p h? th?ng thu gom nu?c vo h? th?ng hi?n t?i khng?",
        "faq_a4": "C, chng ti chuyn c?i t?o tch h?p h? th?ng thu nu?c mua v nu?c xm vo m?ng lu?i hi?n t?i, gi?m dng k? s? ph? thu?c vo ngu?n nu?c d th? v chi phv?n hnh.",
        "faq_q5": "L?i th? c?a khung gi?i php Morales Plumbing PLUS l g?",
        "faq_a5": "K?t h?p chuyn mn CSLB C-36 v?i K? thu?t Mi tru?ng, ch?n don b?ng AI v Quy trnh Lean, mang l?i m?c d? chnh xc v b?n v?ng v song trong khu v?c.",
        "faq_q6": "Morales Plumbing d?m b?o tun th? tiu chu?n UPC nhu th? no?",
        "faq_a6": "Cc k? su c?a chng ti du?c ch?ng nh?n CSLB C-36 v s? d?ng cc giao th?c ki?m tra m h? tr? b?i AI d? d?m b?o m?i m?i n?i vu?t qutiu chu?n c?a California. Ngoi ra, chng ti cung c?p d?ch v? ki?m tra v?t l truy?n th?ng v?i hai thanh tra v danh sch ki?m tra th? cng cho nh?ng khch hng thch gim st co h?c c? di?n. <span class=\"comic-choice\">Quy?t d?nh l c?a b?n</span>: ch?n xc th?c k? thu?t s? h? tr? AI d? chnh xc cao ho?c ki?m tra th? cng truy?n th?ng.",
        "faq_q7": "Nh?ng ch? s? 'Lean' c? th? no du?c theo di?",
        "faq_a7": "Chng ti theo di Takt Time, Lead Time v First-Pass Yield d? d?m b?o quy trnh lm vi?c cth? d? don du?c, khng lng phcho cc d? n quy m l?n. ?ng th?i, chng ti h? tr? theo di cc m?c d? n c? di?n v ki?m ton gi? lm vi?c truy?n th?ng d? gim st don gi?n hon. <span class=\"comic-choice\">Quy?t d?nh l c?a b?n</span>: t?i uu ha d? n b?ng b?ng d? li?u Lean th?i gian th?c, ho?c qu?n l thng qua cc m?c d? n truy?n th?ng don gi?n.",
        "faq_q8": "Lm th? no ti cth? chu?n b? co s? h? t?ng s?n sng cho tuong lai?",
        "faq_a8": "B?ng cch tch h?p cc h? th?ng thu gom nu?c v ti s? d?ng nu?c xm ngay hm nay, b?n s? trnh du?c cc nghia v? c?i t?o trong tuong lai v tang gitr? ti s?n ln t?i 15%. Ho?c b?n cth? ch?n b? c?c th? d?ng c?c k? tin c?y t?p trung vo thay ?ng d?n c? di?n d? b?n cao v c?u hnh ?ng chia don gi?n gip gi?m thi?u b? ph?n co h?c. <span class=\"comic-choice\">Quy?t d?nh l c?a b?n</span>: d?u tu vo cng ngh? nu?c b?n v?ng ch? d?ng, ho?c ch?n h? th?ng vng l?p th? d?ng t b?o tr.",
        "svc_1_title": "Precision Leak Detection",
        "svc_1_p1": "At Morales Plumbing, precision is our standard. We identify hidden faults without destructive demolition.",
        "svc_1_p2": "Using FLIR thermal cameras and acoustic sensors we trace leaks behind walls or slabs. Massive savings vs. reconstruction.",
        ...
        "nav_services": "K? thu?t Chuyn nghi?p",
        "nav_multimedia": "Podcasts",
        "nav_about": "S? m?nh",
        "nav_terminal": "Thi?t b? d?u cu?i",
        "hero_badge": "K? thu?t Chuyn nghi?p & Ch?ng nh?n CSLB C-36",
        "hero_title": "MORALES PLUMBING",
        "hero_desc": "K?t h?p hon 21 nam chuyn mn k? thu?t v?i u?c tnh AI v thi?t k? nu?c b?n v?ng.",
        ...
        "projects_desc": "Cc ?ng d?ng cng ngh? v h? th?ng qu?n l d? n trong th? gi?i th?c c?a chng ti.",
        "card_ep_title": "ORION ESTIMATOR PRO",
        "card_ep_desc": "U?c tnh t? d?ng d?a trn th? gic my tnh, s? h?u +8000 danh m?c d? n. T?i uu ha l?i nhu?n >70%.",
        "card_orion_title": "H? th?ng Chi?n lu?c ORION",
        "card_orion_desc": "Gi?i php quy trnh lm vi?c k? thu?t s? cho cc d? n kh?i lu?ng l?n. H?p d?ng thng minh v theo di th?i gian th?c.",
        "btn_pricing": "Xem B?ng gichnh th?c",
        "btn_buy": "Mua gi?y php",
        "btn_proposal": "Khung chi?n lu?c",
        "btn_academy": "H?c vi?n Orion",
        "services_title": "D?ch v? k? thu?t c?t li",
        "service_1": "Ch?n don hnh ?nh nhi?t",
        "service_1_desc": "Pht hi?n r r? khng xm l?n b?ng hnh ?nh nhi?t d? phn gi?i cao v c?m bi?n m thanh.",
        "service_2": "C?i t?o sinh thi",
        "service_2_desc": "Hi?n d?i ha h? th?ng b?ng v?t li?u thn thi?n v?i mi tru?ng v cng ngh? ti?t ki?m nu?c hi?u qu? (ISO 14001).",
        "service_3": "Thi?t k? co s? h? t?ng th?y l?c",
        "service_3_desc": "Quy ho?ch chuyn gia v? m?ng lu?i th?y l?c d? chnh xc cao cho co s? h? t?ng dn cu v thuong m?i.",
        "manifesto_title": "Tuyn ngn Morales Plumbing",
        "mission_title": "S? m?nh",
        "mission_desc": "D?n d?u ngnh b?ng cch cung c?p cc gi?i php d? chnh xc cao theo tiu chu?n CSLB, k?t h?p hon 21 nam kinh nghi?m k? thu?t v?i AI.",
        "vision_title": "T?m nhn",
        "vision_desc": "Tr? thnh tiu chu?n ton c?u v? k? thu?t ?ng nu?c cng ngh? v k? thu?t b?n v?ng, du?c d?nh nghia b?i s? d?i m?i v chnh tr?c.",
        "terminal_title": "MORALES_EXECUTIVE_V1.0",
                "team_card_title": "DANH B? DOANH NGHI?P",
        "team_card_desc": "K? su u?ng ?ng & Chuyn gia K? thu?t",
        "btn_team_dir": "> TRUY C?P DANH B?",
"profile_role": "K? su tru?ng & Nh sng l?p",
        "cv_link": "> Truy c?p so y?u l l?ch chuyn nghi?p",
        "ceo_link": "> H? SO I?U HNH CEO",
        "network_link": "> M?ng lu?i: ORION TECH",
        "joe_status": "JOE: Tr? l k? thu?t AI",
        "joe_welcome": "Cho m?ng. Ti l Joe. Hm nay ti cth? gip g cho b?n v? ch?n don d? n ho?c d?ch v? k? thu?t?",
        "joe_intro": "Xin cho! Ti l Joe, tr? l AI c?a Morales Plumbing. Hm nay ti cth? gip g cho b?n? ",
        ...
        "nav_tiers": "C?p d?",
        "nav_upsells": "Bn thm",
        "nav_promotions": "Khuy?n mi",
        "nav_terms": "i?u kho?n",
        "nav_warranties": "B?o hnh",
        "pb_hero_badge": "Phin b?n tiu chu?n ngnh",
        "pb_hero_subtitle": "D?ch v? ?ng nu?c chuyn nghi?p | Vng V?nh California",
        "pb_hero_location": "Vng V?nh California",
        "pb_hero_updated": "C?p nh?t: Thng 12 nam 2024",
        "pb_hero_details": "15 d?ch v? chuyn nghi?p chi ti?t",
        "pb_hero_rates": "Ph? trch: $185/gi? | Tr? l: $95/gi? | Ph? ph: 30%",
        "pb_hero_compliance": "Tiu chu?n K? thu?t: ORION Tech | Ch?t lu?ng ?m b?o",
        ...
        "pb_upsells_title": "H? th?ng bn thm",
        "pb_promotions_title": "Khuy?n mi dang ho?t d?ng",
        "pb_terms_title": "i?u kho?n v i?u ki?n",
        "pb_warranties_title": "B?o hnh v H? tr?",
        "pb_catalog_title": "Danh m?c d?ch v?",
        "pricebook_desc": "Phin b?n tiu chu?n ngnh v?i +100 d?ch v? chuyn nghi?p chi ti?t, 3 c?p giv h? th?ng bn thm tch h?p.",
        "pricebook_feat1": "+100 d?ch v?",
        "pricebook_feat2": "C?p d? T?t/T?t hon/T?t nh?t",
        "pricebook_feat3": "Bn thm v Khuy?n mi",
        "card_orion_feat1": "Tch h?p Gogo Rooter",
        "card_orion_feat2": "?ng b? ha dm my",
        "card_orion_feat3": "T?i uu ha ROI",
        "btn_catalog": "Xem danh m?c",
        "btn_demo": "Xem demo",
        "system_core_tag": "C?t li h? th?ng  ang pht tri?n",
        "coming_soon": "S?p ra m?t",
        "coming_soon_badge": "S?p ra m?t",
        "footer_e2ee": "B?o m?t & Uu tin Quy?n ring tu",
        "footer_cyber": "N?n t?ng du?c tang cu?ng b?i AI",
        "footer_rights_long": " 2026 Morales Plumbing. B?o luu m?i quy?n. N?i dung, video, hnh ?nh du?c t?o v cng ngh? ORION / Joe AI l ti s?n trtu? d?c quy?n c?a Morales Plumbing v NeKon AI aGent Consulting.",
        ...
        "slogan_text": "?nh nghia tuong lai c?a dng ch?y. ?i m?i v cu?c s?ng. ",
        "contact_lic": "Gi?y php",
        "pb_method_p1": "Phuong php tnh ton ORION d?a trn cch ti?p c?n k? thu?t chnh xc d?i v?i chi phth?y l?c. Chng ti s? d?ng cc thu?t ton c?p cng nghi?p, xem xt d? b?n v?t li?u, cu?ng d? lao d?ng (phn lo?i theo vai tr Tru?ng v Tr? l) v d? ph?c t?p k? thu?t. i?u ny lo?i b? s? thay d?i trong u?c tnh, cung c?p c?u trc gic? d?nh ph h?p v?i tiu chu?n CSLB v bi?n d?ng c?a th? tru?ng xy d?ng California.",
        "pb_method_p2": "B?ng cch tch h?p d? li?u chu?i cung ?ng th?i gian th?c v quy trnh cng vi?c d?c quy?n hi?u qu? cao, phuong php lu?n c?a chng ti d?m b?o m?c tang git?i uu 30% trong khi duy tr l?i nhu?n b?n v?ng cho vi?c th?c hi?n k? thu?t d? trung th?c cao. Phuong php d?nh gikhoa h?c ny d?m b?o m?i d? n du?c h? tr? b?i d? li?u th?y l?c d du?c xc minh v phn b? ti nguyn minh b?ch.",
        "pb_tiers_p1": "H? th?ng T?t/T?t hon/T?t nh?t cung c?p cho khch hng c?a chng ti ba c?p d? gi?i php k? thu?t khc nhau, du?c ty ch?nh d? dp ?ng cc m?c tiu vng d?i d? n khc nhau. C?p d? 'T?t' t?p trung vo vi?c s?a ch?a tun th? UPC v ph?c h?i hi?u qu?. C?p d? 'T?t hon' gi?i thi?u d? b?n linh ki?n nng cao v nng c?p hi?u su?t t?m trung. C?p d? 'T?t nh?t' d?i di?n cho tiu chu?n ORION Tech: v?t li?u c?p cng nghi?p cao c?p, gim st tch h?p AI v b?o hnh vng d?i m? r?ng.",
        "pb_tiers_p2": "M?i c?p d? du?c thi?t k? d? cung c?p gitr? t?i da trong ph?m vi c?a n, cho php cc bn lin quan v? dn cu v thuong m?i dua ra quy?t d?nh sng su?t d?a trn chi?n lu?c co s? h? t?ng di h?n c?a h?, khng ch? d?a trn nhu c?u tru?c m?t.",
        "pb_upsells_p1": "H? th?ng bn thm c?a chng ti du?c thi?t k? d? cung c?p s? b?o v? co s? h? t?ng ch? d?ng. Ngoi yu c?u chnh, chng ti phn tch mi tru?ng th?y l?c d? d? xu?t cc nng c?p quan tr?ng nhu van ng?t thng minh, h? th?ng l?c nu?c v my bom tu?n hon hi?u su?t cao. Nh?ng b? sung ny khng ch? l ty ch?n m cn l cc kho?n d?u tu chi?n lu?c vo an ton ti s?n.",
        "pb_upsells_p2": "M?i d? xu?t d?u du?c h? tr? b?i d? li?u ch?n don, d?m b?o m?i tch h?p d?u ph?c v? m?c dch ch?c nang trong vi?c ngan ch?n cc l?i trong tuong lai v gi?m chi phv?n hnh di h?n.",
        "pb_promo_p1": "Khung khuy?n mi Morales Plumbing thu?ng cho vi?c b?o tr ch? d?ng v cam k?t d? n kh?i lu?ng l?n. Chng ti cung c?p cc uu di d?nh k? cho vi?c thay th? du?ng ?ng ton nh, t?i uu ha my nu?c nng theo ma v tch h?p ORION Tech l?n d?u. Nh?ng khuy?n mi ny nh?m gi?m ro c?n gia nh?p cho cc gi?i php k? thu?t d? chnh xc cao.",
        "pb_promo_p2": "T?t c? cc khuy?n mi dang ho?t d?ng d?u ph?i ch?u s? ki?m duy?t k? thu?t v khng th? k?t h?p v?i cc chi?t kh?u chi?n lu?c khc, d?m b?o ch?t lu?ng d? n lun l uu tin tuy?t d?i.",
        "pb_terms_p1": "T?t c? cc d?ch v? do Morales Plumbing cung c?p d?u ch?u s? qu?n l c?a H?i d?ng Gi?y php Nh th?u Bang California (CSLB) v Quy chu?n ?ng nu?c Th?ng nh?t (UPC). M?i h?p d?ng bao g?m ph?m vi cng vi?c chi ti?t, d?nh gic? d?nh (khng cph?n) v gi?i thch r rng v? phuong php k? thu?t. C?u trc thanh ton du?c thi?t k? d? ph h?p v?i cc m?c d? n.",
        "pb_terms_p2": "Trch nhi?m php l v gi?i quy?t tranh ch?p tun th? cc tiu chu?n cng nghi?p California, d?m b?o m?i quan h? d?i tc chuyn nghi?p v minh b?ch gi?a nhm k? thu?t v khch hng.",
        "pb_warranty_p1": "Morales Plumbing cung c?p b?o hnh 1 nam tiu chu?n cho t?t c? cng vi?c v tch h?p k? thu?t, v?i b?o hnh m? r?ng cs?n cho cc h? th?ng c?p 'T?t nh?t' v ci d?t ORION Tech. Ngoi ra, chng ti cung c?p cc k? ho?ch tn d?ng linh ho?t v h? th?ng b?o hnh nhn cng tr?n d?i cho cc d? n repipe ton di?n (nu?c, thot nu?c ho?c khd?t). Nhm h? tr? c?a chng ti s? d?ng d? li?u gim st IoT d? cung c?p ph?n ?ng ch?n don nhanh chng, gi?m thi?u th?i gian ch?t v d?m b?o tnh ton v?n c?a h? th?ng.",
        "pb_warranty_p2": "B?o hnh c?a nh s?n xu?t p d?ng cho t?t c? v?t li?u cng nghi?p du?c s? d?ng, v?i Morales Plumbing dng vai tr l di?m lin l?c k? thu?t chnh cho t?t c? cc cu h?i lin quan d?n b?o hnh v ki?m ton h? th?ng.",
        "pb_warranty_note": "*Gim st IoT:* ? c?p d?n vi?c s? d?ng cng ngh? thng minh (van ng?t nu?c Wi-Fi, c?m bi?n r r?, my nu?c nng thng minh) g?i d? li?u v c?nh bo ln dm my d? ch?n don phng ng?a nhanh chng.",
        "pb_prose_p1": "ORION Price Book v6.0 PRO l c?t li v?n hnh c?a Morales Plumbing, du?c thi?t k? d? cung c?p s? minh b?ch tuy?t d?i trong k? thu?t chi ph. Danh m?c ny du?c c?p nh?t d?n thng 12 nam 2024 cho Vng V?nh California, du?c pht tri?n theo cc hu?ng d?n nghim ng?t c?a H?i d?ng Gi?y php Nh th?u Bang California (CSLB) v Quy chu?n ?ng nu?c Th?ng nh?t (UPC), d?m b?o m?i can thi?p k? thu?t d?u du?c h? tr? b?i cc tiu chu?n an ton cng nghi?p v b?n v?ng mi tru?ng.",
        "pb_prose_p2": "C?u trc c?a ti li?u ny uu tin s? r rng cho khch hng, lo?i b? cc tnh ton ph?c t?p t?i ch? v d?m b?o m?i bo gid?u ph?n nh vi?c s? d?ng v?t li?u c?p cng nghi?p v cc phuong php chnh xc d du?c ki?m duy?t theo cc giao th?c hi?u qu? cao. T?i Morales Plumbing, chng ti khng ch? s?a ch?a du?ng ?ng; chng ti thi?t k? cc h? th?ng th?y l?c b?n v?ng cho th? h? tuong lai.",
        "pb_prose_p3": "Phuong php c?a chng ti k?t h?p u?c tnh d?a trn AI v?i hon 21 nam kinh nghi?m th?c d?a, cho php t? l? chnh xc 99% trong phn b? ti nguyn v d? bo ti?n d?. Ch?n ORION l b?n dang ch?n m?t d?i tc co s? h? t?ng chi?n lu?c cam k?t v?i m?c d? xu?t s?c k? thu?t v tnh chnh tr?c cao nh?t.",
        "aq_title": "ORION AQUA GUARD v1.0",
        "aq_desc": "Gim st v qu?n l nng cao cc h? th?ng x? l nu?c d? chnh xc cao. Phn tch pH, d? c?ng v l?c theo th?i gian th?c.",
        "aq_feat1": "Gim st IoT",
        "aq_feat2": "T? d?ng r?a ngu?c",
        "aq_feat3": "C?nh bo d? tinh khi?t",
        "aq_prose_p1": "ORION AQUA GUARD v1.0 d?i di?n cho d?nh cao c?a qu?n l lm s?ch nu?c dn cu v thuong m?i. H? th?ng ny s? d?ng m?ng lu?i cc c?m bi?n IoT d? lin t?c gim st ch?t lu?ng nu?c d?u vo, do lu?ng cc bi?n s? nhu d? c?ng (h?t trn m?i gallon), m?c pH v n?ng d? ch?t gy  nhi?m. D? li?u du?c x? l thng qua cng c? ORION d?c quy?n c?a chng ti d? t?i uu ha hi?u su?t l?c v tiu th? mu?i.",
        "aq_prose_p2": "Ngoi vi?c lm m?m don gi?n, Aqua Guard qu?n l cc don v? th?m th?u ngu?c da t?ng v h? th?ng kh? trng UV. Ngu?i dng nh?n du?c c?nh bo th?i gian th?c thng qua h? sinh thi ORION v? vng d?i b? l?c v d? tinh khi?t gi?m, d?m b?o nu?c dng cho tiu th? v co s? h? t?ng duy tr ? tiu chu?n c?p phng thnghi?m.",
        "aq_prose_p3": "B?ng cch tch h?p Aqua Guard vo m?ng lu?i th?y l?c c?a b?n, b?n ko di tu?i th? c?a t?t c? cc thi?t b? v ph? ki?n h? ngu?n. Kh? nang b?o tr d? don c?a h? th?ng d?m b?o ch? c?n can thi?p khi c?n thi?t v? m?t th?ng k, t? dt?i da ha ch?t lu?ng nu?c v ROI c?a h? th?ng.",
        "hn_title": "ORION HYDRAULIC NEXUS",
        "hn_desc": "Thi?t k? th?y l?c tch h?p CAD v m ph?ng p su?t cho co s? h? t?ng ph?c t?p. Phn ph?i luu lu?ng th? tch du?c t?i uu ha.",
        "hn_feat1": "Tch h?p CAD",
        "hn_feat2": "L?p b?n d? p su?t",
        "hn_feat3": "M ph?ng r r?",
        "hn_prose_p1": "ORION HYDRAULIC NEXUS l b? thi?t k? chuyn nghi?p c?a chng ti d? quy ho?ch v m ph?ng co s? h? t?ng th?y l?c p su?t cao. S? d?ng b?n thi?t k? tch h?p CAD, chng ti t?o ra m?t b?n sao k? thu?t s? c?a h? th?ng ?ng nu?c c?a b?n d? phn tch d?ng l?c h?c dng ch?y, s?t p trn du?ng ch?y di v bi?n s? gin n? nhi?t. i?u ny r?t quan tr?ng d?i v?i cc d? n dn cu cao c?p v thuong m?i nhi?u t?ng, noi cc u?c tnh tiu chu?n thu?ng th?t b?i.",
        "hn_prose_p2": "H? th?ng cho php cc k? su c?a chng ti ki?m tra p l?c m?ng ?o trong cc tnh hu?ng nhu c?u cao di?m khc nhau, xc d?nh cc di?m y?u ti?m ?n tru?c khi l?p d?t m?t du?ng ?ng. Phuong php lu?n ny d?m b?o m?i ph? ki?n d?u nh?n du?c p su?t chnh xc theo yu c?u UPC, lo?i b? 'di?m ch?t' v t?i uu ha t?c d? cung c?p nu?c.",
        "hn_prose_p3": "Hydraulic Nexus cung tch h?p v?i ch?n don nhi?t c?a chng ti, cho php chng ti ph? d? li?u nhi?t th?i gian th?c ln b?n thi?t k? g?c d? pht hi?n r r? chnh xc v ki?m ton co s? h? t?ng. y l cng c? quy?n l?c cho k? thu?t ?ng nu?c chnh xc.",
        "wh_title": "ORION THERMO CORE v2.0",
        "wh_desc": "H? th?ng ch?n don v t?i uu ha thng minh cho my nu?c nng khng bnh ch?a hi?u su?t cao. C?nh bo dng c?n d? don v di?u ch?nh d?t chy.",
        "wh_feat1": "i?u ch?nh d?t chy",
        "wh_feat2": "AI dng c?n",
        "wh_feat3": "T?i uu ha nang lu?ng",
        "wh_prose_p1": "ORION THERMO CORE v2.0 l n?n t?ng qu?n l chuyn d?ng cho cc h? th?ng lm nng nu?c khng bnh ch?a hi?u su?t cao. Khng gi?ng nhu cc my nu?c nng truy?n th?ng, cc don v? khng bnh ch?a hi?n d?i di h?i s? di?u ch?nh d?t chy chnh xc v t?y c?n b? trao d?i nhi?t d?nh k? d? duy tr x?p h?ng AFUE 90%+. Thermo Core s? d?ng c?m bi?n m thanh v luu lu?ng d? pht hi?n d?u hi?u s?m nh?t c?a s? tch t? khong ch?t.",
        "wh_prose_p2": "N?n t?ng cung c?p l?p l?ch t? d?ng cho cc chu k? x? d?a trn m hnh s? d?ng th?c t? thay v l?ch trnh ty . Ncung gim st cc chu k? dnh l?a v t? l? kh-khng khd? d?m b?o h? th?ng ho?t d?ng ? hi?u su?t nhi?t d?nh cao, tr?c ti?p gi?m chi phti?n ch hng thng v d?u chn carbon.",
        "wh_prose_p3": "V?i Thermo Core, Morales Plumbing cung c?p tr?i nghi?m 'thi?t l?p v qun' cho vi?c cung c?p nu?c nng cao c?p. Tch h?p h? th?ng vo h? sinh thi ORION cho php ch?n don t? xa, nghia l cc k? su c?a chng ti thu?ng xc d?nh v gi?i quy?t cc v?n d? hi?u su?t tru?c khi khch hng nh?n th?y nhi?t d? gi?m.",
        "pb_hero_title": "ORION PRICE BOOK v6.0 PRO",
        "pb_search_placeholder": "Tm ki?m d?ch v? (vd: My nu?c nng, Thot nu?c, B?n d? AI...)",
        "cat_all": "T?t c?",
        "cat_diagnostic": "Ch?n don",
        "cat_technical plumbing": "K? thu?t",
        "cat_eco": "B?n v?ng sinh thi",
        "cat_safety": "An ton",
        "price_standard": "Tiu chu?n",
        "price_member": "Thnh vin",
        "lbl_client_view": "Gc nhn Khch hng:",
        "lbl_tech_view": "Thng s? K? thu?t & V?t li?u (3 C?p d?):",
        "doc_title": "? xu?t chi?n lu?c",
        "doc_subtitle": "Lm ch? h? th?ng ?ng nu?c thng minh & K? thu?t mi tru?ng",
        "sig_name": "Alex G. Espinosa",
        "profile_header_role": "Ki?n trc su gi?i php AI c?p cao | K? su mi tru?ng | Qu?n l d? n",
        "app_tratamiento_title": "H? th?ng x? l nu?c",
        "app_tratamiento_detail": "?ng d?ng X? l nu?c qu?n l cc chu k? l?c v lm s?ch nng cao. Cung c?p d? li?u th?i gian th?c v? d? c?ng c?a nu?c, m?c pH v hi?u qu? lo?i b? ch?t gy  nhi?m, cho php b?o tr d? don cc h? th?ng RO cng nghi?p.",
        "app_redes_title": "Thi?t k? m?ng lu?i th?y l?c",
        "app_redes_detail": "?ng d?ng Thi?t k? M?ng lu?i Th?y l?c c?a chng ti cho php m ph?ng d?ng l?c h?c ch?t l?ng ph?c t?p trong mi tru?ng dn cu v thuong m?i. S? d?ng cc thu?t ton chu?n ISO d? t?i uu ha kch thu?c du?ng ?ng v phn ph?i p su?t, gi?m lng phv?t li?u v d?m b?o tun th? UPC/CPC.",
        "app_heaters_title": "My nu?c nng khng bnh ch?a",
        "app_heaters_detail": "?ng d?ng ny t?i uu ha vi?c l?p d?t v hi?u su?t c?a cc h? th?ng lm nng nu?c khng bnh ch?a. Tnh ton nhu c?u luu lu?ng d?nh v yu c?u p su?t khd? d?m b?o cung c?p nu?c nng khng b? gin do?n, bao g?m m?t m-dun ch?n don d? kh?c ph?c s? c?.",
        "legal_title": "Khung php l & B?o m?t m?ng",
        "sec1_title": "K? thu?t Mi tru?ng & B?n v?ng",
        "sec1_legal_p1": "T?t c? n?i dung trn n?n t?ng ny, bao g?m nhung khng gi?i h?n ? video cng ty, hnh ?nh 3D du?c t?o, m ngu?n v c?u trc co s? d? li?u ORION Price Book v6.0 PRO, du?c b?o v? nghim ng?t b?i lu?t s? h?u trtu? v b?n quy?n c?a Hoa K? v Bang California.",
        "sec1_legal_li1": "Morales Plumbing gi? quy?n d?c quy?n d?i v?i thuong hi?u, phuong php k? thu?t, co s? khch hng v danh m?c d?ch v? k? thu?t c?a mnh.",
        "sec1_legal_li2": "NeKon AI aGent Consulting gi? quy?n d?ng tc gi? v cc quy?n d?i v?i h? t?ng AI ('Joe AI'), m hnh m?ng th?n kinh, h? th?ng ch?n don th? gic my tnh v cng ngh? t? d?ng ha h? th?ng ORION co b?n.",
        "sec1_legal_p2": "Nghim c?m sao chp, copy, co, phn ph?i ho?c s? d?ng thuong m?i tri php b?t k? ti li?u da phuong ti?n no du?c luu tr? trong h? sinh thi k? thu?t s? ny.",
        "sec2_legal_title": "2. B?o m?t m?ng v Quy?n ring tu d? li?u",
        "sec2_legal_p1": "?m b?o an ton cho khch hng doanh nghi?p (B2B) v dn cu (B2C) c?a chng ti l uu tin hng d?u. T?t c? cc h? th?ng c?a chng ti ho?t d?ng theo cc giao th?c b?o m?t c?p cng nghi?p nghim ng?t:",
        "sec2_legal_li1": "Pht hi?n nhi?t v h?ng ngo?i: Vi?c thu th?p d? li?u c?u trc thng qua camera nhi?t d? phn gi?i cao v c?m bi?n chnh xc ch? du?c th?c hi?n cho m?c dch ch?n don v?t l khng xm l?n.",
        "sec2_legal_li2": "H?p d?ng thng minh v thanh ton: T?t c? ha don v h?p d?ng du?c t?o d?u du?c b?o v? b?ng m ha d?u cu?i (E2EE).",
        "sec2_legal_li3": "Tuong tc v?i Joe AI: Cc truy v?n g?i cho Joe du?c phn tch ?n danh d? c?i thi?n cng c? d? don, d?ng th?i tn tr?ng quy?n ring tu c?a ngu?i dng.",
        ...
        "sec3_legal_li1": "Khch hng ch?p nh?n cc c?p d? v di?u kho?n d?ch v? T?t/T?t hon/T?t nh?t ph h?p v?i cc tiu chu?n c?a Thnh ph? San Jose.",
        "sec3_legal_li2": "B?o hnh lao d?ng v linh ki?n tun th? nghim ng?t Gi?y php CSLB Class C-36 v cc quy chu?n UPC/CPC.",
        "sec3_legal_li3": "i?u ki?n ch?n don k? thu?t s?: Cc bo co do AI t?o ra ch? l bo co so b?. C?n cs? xc nh?n t?i ch? c?a k? thu?t vin ctrnh d? d? c?p php cu?i cng.",
        "contact_loc": "V? tr",
        "contact_email": "Email",
        "contact_phone": "i?n tho?i",
        "sec1_desc": "Chng ti vu?t ra ngoi h? th?ng ?ng nu?c truy?n th?ng b?ng cch tch h?p cc nguyn t?c k? thu?t mi tru?ng vo t?ng thi?t k? th?y l?c. Chng ti uu tin hi?u qu? s? d?ng nu?c, x? l an ton cc v?t li?u nguy h?i (CSLB C-36 Compliance) v cc h? th?ng khng tc d?ng sinh thi trn ton Bay Area.",
        "sec2_title": "Tch h?p AI & Th? gic My tnh",
        "sec2_desc": "H? th?ng ORION s? d?ng m?ng no-ron d?c quy?n d? pht hi?n r r? khng xm l?n v ch?n don h?ng ngo?i. Th? gic my tnh cho php chng ti l?p b?n d? co s? h? t?ng v?i d? chnh xc milimet, t?i uu ha chi phv ti?n d? th?c hi?n.",
        "sec3_title": "Quy trnh Chi?n lu?c (ORION Framework)",
        "sec3_desc": "Phuong php lu?n c?a chng ti du?c xy d?ng d?a trn d? chnh xc c?a h?p d?ng thng minh v qu?n l d? n theo th?i gian th?c. T? cc d? n cng nghi?p quy m l?n d?n k? thu?t dn d?ng cao c?p theo yu c?u, m?i bu?c d?u du?c tr? l AI c?a chng ti, Joe, ki?m tra.",
        "sec4_title": "M hnh Th?c thi ?ng",
        "sec4_desc": "Chng ti di?u ch?nh cc phuong php B2B v B2C thng qua ORION Price Book v6.0 PRO. Chng ti cung c?p cc phuong n 'Ch? nhn cng' cho t?ng th?u ho?c 'D? n Tr?n gi' v?i ba c?p d? cng ngh? (Good/Better/Best), d?m b?o kh? nang m? r?ng v h?p d?ng ch?t ch?.",
        "cv_header_role": "Ki?n trc su Gi?i php AI C?p cao | K? su Mi tru?ng | Qu?n l D? n",
        "cv_summary_title": "Tm t?t Chuyn mn",
        "cv_summary_p": "K? su Mi tru?ng v Ki?n trc su Gi?i php AI v?i hon 21 nam kinh nghi?m da ngnh. Kh? nang d?c do trong vi?c k?t n?i cc h? th?ng k? thu?t v?t l ph?c t?p v?i Trtu? Nhn t?o tin ti?n. Chuyn gia trong vi?c t?i uu ha quy trnh cng nghi?p, co s? h? t?ng d th? v cc d? n xy d?ng cao c?p. Chuyn gia du?c c?p php v?i thnh tch d du?c ch?ng minh trong qu?n l d? n t?i California v ki?m ton mi tru?ng ISO 14001.",
        "cv_exp_title": "Kinh nghi?m Chuyn mn",
        "cv_edu_title": "Gio d?c & Ch?ng ch?",
        "cv_skills_title": "K? nang K? thu?t",
        "cv_lang_title": "Ngn ng?",
        "lbl_justification": "L do:",
        "lbl_materials": "V?t li?u:",
        "lbl_tools": "Cng c?/Thi?t b?:",
        "lbl_time": "Th?i gian u?c tnh:",
        "eco_podcasts_card_title": "Thu vi?n Podcast ORION",
        "eco_podcasts_card_desc": "Cc m thanh tuong tc cd? trung th?c cao v cc phn tch ph?n bi?n v? cu?c cch m?ng AI trong co s? h? t?ng nu?c v cc khung tun th? c?a California.",
        "btn_open_podcasts": "Nghe cc Podcast",
        "multimedia_title": "Thu vi?n Podcast ORION",
        "multimedia_subtitle": "Hi?u bi?t su s?c v? m thanh d? trung th?c cao & Phn tch ph?n bi?n",
        "mp_podcasts_title": "Chu?i H? sinh thi MP",
        "pod_type_deep_dive": "Phn tch Su",
        "mp_pod_1_title": "AI Thung lung Silicon bi?n d?i ngnh ?ng nu?c hi?n d?i",
        "btn_listen": "Nghe Ngay",
        "pod_type_brief": "Tm t?t",
        "mp_pod_2_title": "AI d? don r r? nu?c",
        "pod_type_critique": "Bnh lu?n",
        "mp_pod_3_title": "Ch?n don AI & Trch nhi?m Php l",
        "ep_podcasts_title": "Chu?i EP Estimator Pro",
        "ep_pod_1_title": "EP PLUMBING: Phn tch Ph?n bi?n",
        "ep_pod_2_title": "Th? s?a ?ng nu?c AI trong ti b?n",
        "pod_type_debate": "Tranh lu?n",
        "ep_pod_3_title": "Ch?n don & Khung php l",
        "app_mp_title": "Morales Plumbing ORION Client Portal",
        "app_mp_desc": "C?ng thng tin giao ti?p t?p trung d? qu?n l khch hng v bo co k? thu?t.",
        "app_mp_detail": "C?ng thng tin Morales Plumbing (MP) t?p trung ha vi?c giao ti?p v?i khch hng, cho php d?t l?ch thng minh v truy c?p cc bo co k? thu?t do Joe AI c?a chng ti t?o ra. Nd?m b?o tnh minh b?ch hon ton trong m?i giai do?n c?a d? n.",
        "app_ep_title": "Orion Estimator Pro",
        "app_ep_desc": "B? u?c tnh d?a trn AI v?i Th? gic my tnh d? phn b? ti nguyn cd? chnh xc cao.",
        "app_ep_detail": "Orion Estimator Pro s? d?ng cc thu?t ton th? gic my tnh d? phn tch b?n v? thi?t k? v ?nh th?c d?a, t?o ra B?ng k v?t li?u (BOM) v u?c tnh nhn cng v?i d? chnh xc 99%. Tch h?p v?i hon 8000 m?t hng du?c c?p nh?t theo th?i gian th?c cho th? tru?ng California.",
        "app_redes_desc": "Trnh m ph?ng m?ng lu?i th?y l?c v?i tch h?p CAD v l?p b?n d? p su?t.",
        "app_tratamiento_desc": "H? th?ng qu?n l tin ti?n cho cc chu k? l?c v tinh ch?.",
        "app_heaters_desc": "M-dun ch?n don thng minh d? t?i uu ha h? th?ng su?i ?m nu?c hi?u qu? cao.",
        "app_pricebook_detail": "ORION Price Book v6.0 PRO l m?t cng c? k? thu?t chi phtiu chu?n ha gid?ch v? trn kh?p Vng V?nh. Ns? d?ng m?t h? th?ng phn c?p (T?t/T?t hon/T?t nh?t) d? cung c?p cc ty ch?n linh ho?t tun th? cc tiu chu?n an ton c?a UPC.",
        "swh_title": "D?ch v? my nu?c nng",
        "swh_subtitle": "L?p d?t, Thay th? & Nng c?p",
        "swh_intro": "Khm phcc lo?i cng ngh? lm nng nu?c khc nhau cs?n cho ngi nh c?a b?n v quy trnh l?p d?t chuyn nghi?p c?a chng ti.",
        "swh_tankless_title": "My nu?c nng khng bnh ch?a",
        "swh_tankless_comic_1": "Nu?c nng v t?n theo yu c?u.",
        "swh_tankless_comic_2": "Treo tu?ng, ti?t ki?m khng gian qu gi.",
        "swh_tankless_comic_3": "Hi?u su?t cao, ch? lm nng khi b?n c?n.",
        "swh_gas_title": "My nu?c nng gas tiu chu?n",
        "swh_gas_comic_1": "Bnh ch?a truy?n th?ng v dng tin c?y.",
        "swh_gas_comic_2": "Th?i gian ph?c h?i nhanh khi s? d?ng nhi?u.",
        "swh_gas_comic_3": "Luu : B? lo?i b? d?n vo nam 2027 theo quy t?c BAAQMD.",
        "swh_hp_title": "Bom nhi?t Hybrid",
        "swh_hp_comic_1": "Tuong lai c?a h? th?ng lm nng nu?c khng pht th?i.",
        "swh_hp_comic_2": "Chi?t xu?t nhi?t t? khng kh, ti?t ki?m d?n 70% nang lu?ng.",
        "swh_hp_comic_3": "? di?u ki?n nh?n m?c hon ti?n t?i da t? chnh ph?.",
        "nav_hp_packages": "Cc gi Bom Nhi?t 2027",
        "nav_tt_upgrade": "Nng c?p t? Bnh ch?a sang Khng bnh ch?a",
        "nav_ttt_replace": "Thay th? Khng bnh ch?a sang Khng bnh ch?a",
        "req_hp_title": "Bom nhi?t Hybrid: Yu c?u k? thu?t",
        "req_hp_elec": "Yu c?u v? i?n v Khng gian",
        "req_hp_1": "M?ch di?n 240V / 30-Amp chuyn d?ng (d?i v?i h?u h?t cc m?u 50-80 gallon).",
        "req_hp_2": "Khng gian khng khxung quanh t?i thi?u 700 feet kh?i d? trao d?i nhi?t t?i uu.",
        "req_hp_3": "u?ng ?ng x? nu?c ngung t? du?c d?n d?n c?ng thot nu?c ho?c my bom ph h?p.",
        "req_hp_4": "Kho?ng tr?ng t nh?t 6 inch ? pha trn thi?t b? cho b? l?c khng kh.",
        "req_hp_5": "Dy deo ch?ng d?ng d?t ? 1/3 pha trn v du?i c?a bnh ch?a.",
        "req_hp_6": "Bnh gin n? nhi?t du?c l?p d?t ? d?u vo nu?c l?nh.",
        "req_hp_7": "T? d?ng dp ?ng tiu chu?n khng pht th?i BAAQMD Quy t?c 9-6.",
        "req_code": "Tun th? Quy t?c & An ton",
        "req_tt_title": "Tank to Tankless: Yu c?u k? thu?t",
        "req_tt_gas": "Co s? h? t?ng Khd?t & Thng hoi",
        "req_tt_1": "Yu c?u du?ng ?ng gas chuyn d?ng ckh? nang cung c?p 199.000 BTU/h.",
        "req_tt_2": "?ng thng hoi b?ng thp khng g? lo?i III/IV m?i ho?c ?ng PVC Schedule 40 tr?c ti?p qua mi ho?c tu?ng.",
        "req_tt_3": "? c?m di?n 120V tiu chu?n cho b?ng di?u khi?n k? thu?t s? v dnh l?a di?n t?.",
        "req_tt_4": "Van cch ly chuyn d?ng d? x? v b?o tr hng nam.",
        "req_tt_5": "B? trung ha nu?c ngung (n?u x? vo gang ho?c c?ng cng c?ng).",
        "req_ttt_title": "Tankless to Tankless: Yu c?u k? thu?t",
        "req_ttt_plumb": "Cn nh?c H? th?ng nu?c & C?i t?o",
        "req_ttt_1": "Ti s? d?ng du?ng ?ng gas hi?n cv?i gi? d?nh dp ?ng d? 199.000 BTU/h.",
        "req_ttt_2": "i?u ch?nh ?ng thng hoi PVC hi?n cd? ph h?p v?i c? x? c?a thi?t b? m?i.",
        "req_ttt_3": "Nng c?p cc van cch ly n?u cc van cu b? dng c?n nghim tr?ng ho?c r r?.",
        "req_ttt_4": "L?p d?t b? l?c ch?ng dng c?n d? b?o v? b? trao d?i nhi?t m?i.",
        "req_ttt_5": "Ki?m tra van di?u p (PRV) d? d?m b?o p su?t nh khng vu?t qu80 PSI.",
        "promo_tt_good_comic_1": "1. Ng?t k?t n?i, x? nu?c v tho d? my nu?c nng cbnh ch?a cu c?ng k?nh.",
        "promo_tt_good_comic_2": "2. G?n thi?t b? Navien, l?p d?t ?ng thng hoi PVC m?i v du?ng ?ng gas 199K BTU chuyn d?ng.",
        "promo_tt_good_comic_3": "3. Hi?u ch?nh cc c?m bi?n bn trong d? ki?m sot luu lu?ng v nhi?t d? t?i uu.",
        "promo_tt_good_comic_4": "4. Ph?c h?i h? th?ng nu?c nng v t?n, ti?t ki?m khng gian l?n trong nh d? xe.",
        "promo_ttt_better_comic_1": "1. Tho d? an ton thi?t b? khng bnh ch?a d cu k? v dng c?n.",
        "promo_ttt_better_comic_2": "2. L?p d?t b? l?c nu?c ch?ng c?n d? b?o v? b? trao d?i nhi?t kp m?i.",
        "promo_ttt_best_comic_1": "3. L?p d?t van di?u p (PRV) h?ng n?ng d? di?u ch?nh p su?t nu?c ton b? ngi nh.",
        "promo_ttt_best_comic_4": "4. H? th?ng Navien Cao c?p d tr?c tuy?n v?i di?u khi?n WiFi Thng minh v s? an tm tr?n d?i.",
        "btn_ley_baaqmd": "Lu?t & Quy t?c BAAQMD 2027",
        "btn_req_hp": "Xem Yu c?u K? thu?t & So d? (Bom Nhi?t)",
        "btn_req_tt": "Xem Yu c?u K? thu?t & So d? (Bnh ch?a sang Khng bnh ch?a)",
        "btn_req_ttt": "Xem Yu c?u K? thu?t & So d? (Khng bnh ch?a sang Khng bnh ch?a)"
    }
};
 ...
 * NAVIGATION SYSTEM
 */
function navigate(sectionId, pushState) {
    if (pushState === undefined) pushState = true;
    const sections = document.querySelectorAll('.page-section');
    
    // If sections not in DOM yet, wait for DOMContentLoaded and retry
    if (sections.length === 0) {
        document.addEventListener('DOMContentLoaded', function() { navigate(sectionId, pushState); }, { once: true });
        return;
    }
    ...
    if (target && target.classList.contains('page-section')) {
        ...
        if (pushState) {
            try {
                ...
                // file:// protocol doesn't support pushState - silent fail is OK
            }
        }
    }
}
// Expose on window so inline onclick handlers always find it
...
function getJoeLocalFallback(input) {
    ...
    if (input.match(/cobre|copper|elite|repiping/)) return "Nuestro mdulo Elite Copper Renovations reemplaza sistemas obsoletos por tuberas de cobre de alta pureza (Tipos L y K). Ofrecemos durabilidad ssmica extrema y agua libre de plsticos para el Bay rea.";
    ...
    if (activeTier === "free" && appts.length >= 5) {
        if (warningContainer) {
            const warnMsg = curLang === 'es' ? 
                `?? Has alcanzado el lmite de 5 citas de prueba gratuitas. Mejora a un plan Standard o Premium para seguir programando citas e integrando con el Ecosistema Orion.` :
...
if(typeof translations !== 'undefined' && translations['es']) {
    ...
    "ai_intro_1": "Bienvenidos a la Academia Morales. Soy su Instructor Senior y hoy no solo les entrego una llave inglesa, sino las llaves del ecosistema tecnolgico ms avanzado en la historia de los servicios hdricos.",
    ...
    "ai_intro_4": "Esta mentalidad de vanguardia es lo que separa a un plomero convencional de un consultor tecnolgico de la Academia Morales. Para dominar este entorno, su primera herramienta no ser un soplete, sino su copiloto digital.",
    "ai_s1_title": "1. Tu Copiloto Digital: Quin es Joe AI?",
    "ai_s1_p1": "En el campo de batalla de la infraestructura hdrica, el conocimiento es poder. Joe AI es nuestro asistente virtual multimodal, un Modelo de Lenguaje de Gran Escala (LLM) que ha sido fine-tuned (ajustado finamente) especficamente con el Cdigo de Plomera de California (CPC) y los esquemas tcnicos de fabricantes lderes. Joe no 'adivina'; Joe procesa datos vectoriales en tiempo real.",
    ...
    "ai_t_r4_3": "40% ms rpida; resolucin en la primera cita.",
    ...
    "ai_s3_title": "3. Ver lo Invisible: Termografa FLIR con Inteligencia Artificial",
    "ai_s3_p1": "Para alcanzar la verdadera precisin de Grado Militar, utilizamos cmaras termogrficas de alta resolucin (modelos FLIR E8-XT o C5). Al integrar estas cmaras con algoritmos de IA, realizamos un 'Mapeo Trmico' que identifica gradientes de temperatura invisibles al ojo humano.",
    ...
    "ai_s3_p3": "Gracias al MSX y al procesamiento de IA, el margen de error para localizar una ruptura bajo el concreto se reduce a menos de 3 pulgadas cuadradas. Una vez que hemos 'visto' lo invisible, el siguiente paso es presentar la solucin con el mismo nivel de sofisticacin tecnolgica.",
    "ai_s4_title": "4. La Tablet como Herramienta de Cierre: Orion Price Book",
    "ai_s4_p1": "El profesionalismo extremo se consolida en el momento de la cotizacin. El sistema Orion Price Book POS utiliza la psicologa de ventas para eliminar la friccin del precio. Presentamos siempre tres opciones: 'Good, Better, Best'.",
    ...
    "ai_s4_li3": "<strong>Transparencia Flat Rate:</strong> Usen precios cerrados. El cliente paga por la solucin, no por las horas que ustedes pasen en el sitio.",
    ...
    "ai_s5_p1": "En la Academia Morales, no los estamos formando para ser plomeros; los estamos entrenando para gestionar un ecosistema de alta tecnologa. Al dominar Joe AI, la termografa de grado militar y el sistema Orion, garantizamos una tasa de resolucin en la primera visita superior al 95%.",
