...
const translations = {
    ...
    "vi": {
        ...
        "service_3_desc": "Quy hoạch chuyên gia về mạng lưới thủy lực độ chnh xc cao cho cơ sở hạ tầng dân cư và thương mại.",
        ...
        "joe_intro": "Xin chào! Tôi là Joe, trợ lý AI của Morales Plumbing. Hôm nay tôi cthể gip gì cho bạn? 🛠️",
        ...
        "pb_terms_p1": "Tất cả cc dịch vụ do Morales Plumbing cung cấp đều chịu sự quản lý của Hội đồng Giấy php Nhà thầu Bang California (CSLB) và Quy chuẩn Ống nước Thống nhất (UPC). Mỗi hợp đồng bao gồm phạm vi công việc chi tiết, định gicố định (không cphẩn) và giải thch rõ ràng về phương php kỹ thuật. Cấu trc thanh ton được thiết kế để phù hợp với cc mốc dự n.",
        "pb_terms_p2": "Trch nhiệm php lý và giải quyết tranh chấp tuân thủ cc tiêu chuẩn công nghiệp California, đảm bảo mối quan hệ đối tc chuyên nghiệp và minh bạch giữa nhm kỹ thuật và khch hàng.",
        ...
        "sig_name": "Alex G. Espinosa",
        "profile_header_role": "Kiến trc sư giải php AI cấp cao | Kỹ sư môi trường | Quản lý dự n",
        ...
        "cv_header_role": "Kiến trc sư Giải php AI Cấp cao | Kỹ sư Môi trường | Quản lý Dự n",
        ...
        "req_hp_7": "Tự động đp ứng tiêu chuẩn không pht thải BAAQMD Quy tắc 9-6.",
...
function openBooking() {
    ...
    const bookingMessages = {
        ...
        'es': 'Quiero agendar una cita de servicio de plomera.',
        'zh': '我想preabout管道服务预约。',
...
async function callGemini(apiKey) {
    ...
    const contents = [
        ...
        { role: 'model', parts: [{ text: 'Entendido! Soy Joe, el asistente IA de Morales Plumbing. En qute ayudo?' }] },
        ...joeHistory.map(m => ({
...
function getJoeLocalFallback(input) {
    if (input.match(/hola|hello|hi|buenos|saludos/)) return "Hola! Soy Joe, el asistente IA de Morales Plumbing. Cmo te puedo ayudar hoy con tu infraestructura hidrulica? 🛠️";
    if (input.match(/precio|price|cuanto|cost|cotizaci/)) return "Contamos con el ORION PRICE BOOK v6.0 PRO, que incluye +100 Servicios Profesionales con 3 niveles de Plomera Tcnica (Good/Better/Best). Puedes ver el catlogo en la seccin 'Ecosistema'.";
    if (input.match(/cobre|copper|elite|repiping/)) return "Nuestro mdulo Elite Copper Renovations reemplaza sistemas obsoletos por tuberas de cobre de alta pureza (Tipos L y K). Ofrecemos durabilidad ssmica extrema y agua libre de plsticos para el Bay Area.";
    if (input.match(/septi|septic|fosa|drenaje/)) return "En Septic Systems, instalamos biodigestores anaerobios de flujo ascendente y campos de infiltracin inteligentes. Es la solucin perfecta y ecolgica (cumpliendo con la CA Water Board) para zonas rurales o off-grid.";
    ...
    if (input.match(/servicio|service|hacen|cuale/)) return "Ofrecemos Plomera Tcnica de precisin: Diagnstico por Termografa, Elite Copper Renovations, Septic Systems, Eco-Retrofitting y Diseo CAD de Redes Hidrulicas.";
    ...
    if (input.match(/app|aplicacion|estimador|orion|price book/)) return "ORION es nuestro ecosistema tecnolgico de plomera: Estimador Pro, Price Book v6.0, Portal MP y simuladores hidrulicos CAD. Tecnologa de punta al servicio del flujo.";
    return "Excelente pregunta! Como IA, an estoy aprendiendo algunos detalles especficos. Te invito a explorar nuestros servicios Elite en la seccin 'Ecosistema' o contactar a Alex Espinosa directamente para Plomera Tcnica de alto nivel. 🔧";
}
