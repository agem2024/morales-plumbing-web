...
"profile_role": "Ingeniero Principal y Fundador",
    ...
    "zh": {
        ...
        "terminal_title": "MORALES_EXECUTIVE_V1.0",
                "team_card_title": "公司团队名录",
        "team_card_desc": "管道工程师与技术专家",
        "btn_team_dir": "> 访问名录",
...
"profile_role": "Principal technician & Tagapagtatag",
    ...
    "vi": {
        ...
        "btn_eco_systems": "⚡ Hệ thống my nước nng Eco",
        "promo_wp_title": "2027 Zero-NOx Mandate: Heat Pump Water Heaters",
        "promo_wp_desc": "Ensure compliance with BAAQMD Regulation 9, Rule 6. Transition to ultra-efficient electric Heat Pump Water Heaters before the 2027 deadline.",
        "btn_upgrade": "View Plans",
        "promo_wp_why_title": "Why Upgrade Now?",
        ...
        "terminal_title": "MORALES_EXECUTIVE_V1.0",
                "team_card_title": "DANH BẠ DOANH NGHIỆP",
        "team_card_desc": "Kỹ sư Đường ống & Chuyên gia Kỹ thuật",
        "btn_team_dir": "> TRUY CẬP DANH BẠ",
...
if(typeof translations !== 'undefined' && translations['zh']) {
    ...
    "ai_title": "管道的未来：人工智能时代入门指南",
    "ai_intro_1": "欢迎来到莫拉莱斯学院。我是你们的高级讲师，今天我不仅给你们一把扳手，还要给你们供水服务历史上最先进的技术生态系统的钥匙。",
    "ai_intro_2": "在 Morales Plumbing，我们已经把人工猜测的时代抛在脑后，进入了“精确打击”时代。你们不是普通的学徒；你们是硅谷新的技术精英，是一支将行业的汗水与军用级人工智能的头脑结合在一起的行动力量。",
    "ai_intro_3": "看看我们的盾牌：里面有一个微芯片的半透明水滴不仅仅是设计。它象征着我们的“科技服务”理念：通过数字创新绝对控制水流。",
    "ai_quote": "“我们的使命是提供最高质量的解决方案，将手工技术经验与先进的 AI 技术融合在一起，快速彻底地保护公众健康和家庭的完整性。” — Morales Plumbing 理念",
    "ai_intro_4": "这种前沿的心态将传统水管工与莫拉莱斯学院的技术顾问区分开来。要掌握这个环境，您的第一个工具将不是喷灯，而是您的数字副驾驶。",
    "ai_s1_title": "1. 您的数字副驾驶：Joe AI 是谁？",
    "ai_s1_p1": "在供水基础设施的战场上，知识就是力量。Joe AI 是我们的多模式虚拟助手，这是一个大型语言模型 (LLM)，已根据加州管道规范 (CPC) 和领先制造商的技术图表进行了微调。Joe 不“猜测”；Joe 实时处理矢量数据。",
    "ai_s1_p2": "通过光学字符识别 (OCR)，您可以扫描任何设备的铭牌，Joe AI 将在不到 3 秒的时间内提供准确的手册和逐步诊断树。这个工具就是我们将诊断时间减少 40% 的原因。",
    "ai_t_h1": "特点",
    "ai_t_h2": "传统方法（猜测）",
    "ai_t_h3": "莫拉莱斯方法（Joe AI）",
    "ai_t_r1_1": "诊断",
    "ai_t_r1_2": "基于“试错”。",
    "ai_t_r1_3": "基于矢量数据和准确手册。",
    "ai_t_r2_1": "知识检索",
    "ai_t_r2_2": "几分钟或几小时搜索 PDF。",
    "ai_t_r2_3": "通过自然语言 < 3 秒。",
    "ai_t_r3_1": "信息",
    "ai_t_r3_2": "书籍或互联网的手动搜索。",
    "ai_t_r3_3": "通过铭牌 OCR 立即访问。",
    "ai_t_r4_1": "速度",
    "ai_t_r4_2": "慢，容易需要第二次上门。",
    "ai_t_r4_3": "快 40%；在第一次预约解决。",
    "ai_s1_p3": "这种效率不仅使我们在技术上万无一失，而且在每次干预的监管屏蔽上也是万无一失的。",
    "ai_s2_title": "2. PlumbAssist AI：您的技术合规保证",
    "ai_s2_p1": "作为加州的精英，我们在法律的显微镜下运作。PlumbAssist AI 是您的合规监护人。当您工作时，该系统会实时将每个决定与加州管道规范 (CPC) 进行交叉引用。但其功能超越了技术法规；它与莫拉莱斯法律生成器集成。该系统自动创建保护我们的责任和客户权利的关键文档，确保每份合同无懈可击。",
    "ai_s2_li1": "<strong>监管安全：</strong> 立即查找 CPC，消除由于记忆力差造成的错误。",
    "ai_s2_li2": "<strong>自动文档管理：</strong> 立即生成“取消权”通知和“给所有者的通知”(NTO) 文件，以保护我们的留置权。",
    "ai_s2_li3": "<strong>责任屏蔽：</strong> 在开始任何破坏性工作之前创建定制豁免。",
    "ai_s2_p2": "数据和法律保护我们的责任，但我们的传感器使我们能够看穿坚固的混凝土。",
    "ai_s3_title": "3. 看见隐形：带有 AI 的 FLIR 热成像技术",
    "ai_s3_p1": "为了实现真正的军用级精度，我们使用高分辨率热像仪（FLIR E8-XT 或 C5 型号）。通过将这些相机与 AI 算法结合，我们执行“热映射”，识别肉眼看不见的温度梯度。",
    "ai_s3_p2": "这使我们能够检测“花卉异常”——由热水在板下逸出产生的热羽流或“羽化”效果——在不需要不必要的拆除的情况下定位板漏水。高端 MSX (多光谱动态成像) 技术从视觉相机提取结构细节，并将它们压印在热图像上。",
    "ai_s3_p3": "多亏了 MSX 和 AI 处理，在混凝土下定位破裂的误差范围减小到不到 3 平方英寸。一旦我们“看到”隐形的东西，下一步就是在相同的技术成熟度水平上提出解决方案。",
    "ai_s4_title": "4. 平板电脑作为收尾工具：Orion 价格簿",
    "ai_s4_p1": "极端专业主义在报价时得到巩固。Orion 价格簿 POS 系统利用销售心理学来消除价格摩擦。我们总是提供三种选项：“Good, Better, Best”。",
    "ai_s4_p2": "作为教官，我们教你一个秘诀：“最佳”（高级）选项起到价格锚定的作用，使得“更好”（推荐）选项被认为具有最高逻辑价值。在这里，我们将维修转化为资产升级。为成功达成交易，请在平板电脑上遵循此方案：",
    "ai_s4_li1": "<strong>视觉证据：</strong> 向客户展示 FLIR 相机的图像和 Joe AI 的报告。",
    "ai_s4_li2": "<strong>提出选项：</strong> 提供真实的解决方案，例如 Navien NPE-240A 可获得无限量热水或 Uponor PEX-A 全面重装管道系统。",
    "ai_s4_li3": "<strong>统一定价透明度：</strong> 使用预先定价。客户为解决方案付款，而不是为你现场花费的时间付款。",
    "ai_s4_li4": "<strong>成交和合法签署：</strong> 客户签署莫拉莱斯法律生成器生成的合同，立即收到数字副本。",
    "ai_s4_p3": "这个过程产生了“超级专业主义”，证明了我们的优质收费，并巩固了您在客户面前的权威。",
    "ai_s5_title": "5. 结论：明天的技术员",
    "ai_s5_p1": "在莫拉莱斯学院，我们不是培训你们做水管工；我们正在培训您管理高科技生态系统。通过掌握 Joe AI，军用级热成像技术和 Orion 系统，我们保证第一次访问的解决率超过 95%。",
    "ai_s5_p2": "你们是受科学尊严行业所孕育出来的未来。你不只修管道；你们以医生的精准和数据工程师的智慧保护着硅谷的基础设施。记住：创新和技术尊严是我们的旗帜。欢迎来到精英阶层。",
...
if(typeof translations !== 'undefined' && translations['vi']) {
    ...
    "ai_s1_title": "1. Phi công phụ kỹ thuật số của bạn: Joe AI là ai?",
    "ai_s1_p1": "Trên chiến trường cơ sở hạ tầng nước, kiến thức là sức mạnh. Joe AI là trợ lý ảo đa phương thức của chúng tôi, một Mô hình ngôn ngữ lớn (LLM) đã được tinh chỉnh riêng với Quy định Hệ thống ống nước California (CPC) và sơ đồ kỹ thuật của các nhà sản xuất hàng đầu. Joe không 'đoán'; Joe xử lý dữ liệu véc tơ trong thời gian thực.",
    "ai_s1_p2": "Thông qua Nhận dạng Ký tự Quang học (OCR), bạn có thể quét biển dữ liệu của bất kỳ thiết bị nào và Joe AI sẽ cung cấp, trong vòng chưa đầy 3 giây, hướng dẫn sử dụng chính xác và sơ đồ chẩn đoán từng bước. Công cụ này là lý do tại sao chúng tôi giảm 40% thời gian chẩn đoán.",
    "ai_t_h1": "Đặc tính",
    "ai_t_h2": "Phương pháp truyền thống (Dự đoán)",
    "ai_t_h3": "Phương pháp Morales (Joe AI)",
    "ai_t_r1_1": "Chẩn đoán",
    "ai_t_r1_2": "Dựa trên 'thử và sai'.",
    "ai_t_r1_3": "Dựa trên dữ liệu vectơ và hướng dẫn sử dụng chính xác.",
    ...
    "ai_s2_p1": "Là những người ưu tú của California, chúng tôi hoạt động dưới kính hiển vi pháp lý. PlumbAssist AI là người bảo vệ tuân thủ của bạn. Khi bạn làm việc, hệ thống này tham chiếu chéo mọi quyết định với Quy định Hệ thống ống nước California (CPC) theo thời gian thực. Nhưng chức năng của nó vượt ra ngoài các quy định kỹ thuật; nó được tích hợp với Trình tạo pháp lý Morales. Hệ thống này tự động tạo ra các tài liệu quan trọng để bảo vệ trách nhiệm của chúng tôi và quyền lợi của khách hàng, đảm bảo mọi hợp đồng đều không thể xuyên thủng.",
    ...
    "ai_s3_p2": "Điều này cho phép chúng tôi phát hiện 'sự bất thường của hoa' —hiệu ứng khối nhiệt hoặc 'tạo lông' do nước nóng thoát ra dưới lớp bê tông tạo ra— định vị các rò rỉ tấm (slab leaks) mà không cần phá dỡ không cần thiết. Công nghệ MSX (Multi-Spectral Dynamic Imaging) cao cấp trích xuất chi tiết cấu trúc từ camera hình ảnh và dập nổi chúng trên ảnh nhiệt.",
    ...
    "ai_s4_p1": "Sự chuyên nghiệp cực độ được củng cố vào thời điểm báo giá. Hệ thống POS Orion Price Book sử dụng tâm lý bán hàng để loại bỏ xích mích về giá cả. Chúng tôi luôn đưa ra ba lựa chọn: 'Tốt, Tốt hơn, Tốt nhất'.",
    "ai_s4_p2": "Là người hướng dẫn, chúng tôi dạy bạn bí mật: lựa chọn 'Tốt nhất' (Cao cấp) hoạt động như một điểm neo giá, khiến lựa chọn 'Tốt hơn' (Khuyến nghị) được coi là giá trị hợp lý cao nhất. Đây là nơi chúng tôi biến một sửa chữa thành một nâng cấp tài sản. Để chốt đơn hàng thành công, hãy làm theo quy trình này trên máy tính bảng của bạn:",
    "ai_s4_li1": "<strong>Bằng chứng trực quan:</strong> Cho khách hàng xem hình ảnh từ camera FLIR và báo cáo của Joe AI.",
    ...
    "ai_s5_p1": "Tại Học viện Morales, chúng tôi không đào tạo bạn thành thợ sửa ống nước; chúng tôi đang đào tạo bạn quản lý một hệ sinh thái công nghệ cao. Bằng cách làm chủ Joe AI, phép đo nhiệt độ cấp độ quân sự và hệ thống Orion, chúng tôi đảm bảo tỷ lệ giải quyết lần đầu trên 95%.",
