...
const translations = {
    "en": {
        ...
        "qs_btn_call": "Call: (669) 234-2444 / (669) 213-4422",
    ...
    "es": {
        ...
        "lp_t1_d": "\"No pensque fuera tan fcil. Cambila vlvula del inodoro siguiendo los 4 pasos grficos en 15 minutos y me ahorr$150 USD de un fontanero. Excelente gua!\"",
        "lp_t1_n": "- Maria G., Los Angeles",
        ...
        "lp_a3": "Todas las guas inician con el paso de seguridad ms importante (como cerrar la llave de paso). Si algo sale mal, tu casa estsegura. Adems, nuestro asistente Joe AI estdisponible para ayudarte.",
        ...
        "diy_gfi_desc": "Sin energa en el triturador? Prueba este rpido reinicio elctrico.",
        ...
        "svc_14_good_desc": "Test rpido in-situ. Medicin de TDS (Slidos Disueltos Totales), prueba de dureza por gotas qumicas y nivel de cloro libre.",
        ...
        "promo_ttt_legal_mandate_desc": "A partir del 1 de enero de 2027, estarestrictamente prohibida la instalacin de calentadores de gas en el Área de la Baha. Esta promocin prepara su hogar para el futuro.",
        ...
        "law_subtitle": "La gua definitiva sobre el mandato 2027 de cero emisiones (Zero-NOx) para el Área de la Baha, los nuevos tipos de calentadores y los estrictos requisitos de instalacin de CSLB y el Ttulo 24 de California.",
        "law_sec1_title": "1. El Mandato de BAAQMD 2027 (Regulacin 9, Regla 6)",
        "law_sec1_p1": "El Distrito de Gestin de la Calidad del Aire del Área de la Baha (BAAQMD) ha emitido una enmienda histrica para reducir la contaminacin por xidos de nitrgeno (NOx).",
        "law_sec1_p2": "<strong>¿Quésignifica esto?</strong> A partir del 1 de enero de 2027, serilegal vender o instalar nuevos calentadores de agua residenciales de gas natural que emitan NOx. Esto significa la eliminacin gradual completa de los calentadores tradicionales a gas en el Área de la Baha.",
        ...
        "promo_wp_legal_mandate_desc": "A partir del 1 de enero de 2027, la instalacin de calentadores a gas estarestrictamente prohibida en el Área de la Baha. Esta promocin prepara su hogar para el futuro.",
        ...
        "promo_tt_legal_mandate_desc": "A partir del 1 de enero de 2027, la instalacin de calentadores a gas estarestrictamente prohibida en el Área de la Baha. Esta promocin prepara su hogar para el futuro.",
        ...
        "promo_ttt_legal_title": "Trminos Legales, Mandatos y Reembolsos",
        "promo_ttt_legal_mandate_title": "1. Mandato BAAQMD (Reg 9, Regla 6):",
        "promo_ttt_legal_mandate_desc": "A partir del 1 de enero de 2027, la instalacin de calentadores a gas estarestrictamente prohibida en el Área de la Baha. Esta promocin prepara su hogar para el futuro.",
        ...
        "faq100_q_2": "¿Quépasa si la presin del agua es muy alta?",
        ...
        "faq100_q_18": "¿Por qué me quedo sin agua caliente tan rpido?",
        ...
        "faq100_a_22": "Es plstico flexible resistente a congelacin, econmico y rpido de instalar.",
        ...
        "faq100_q_47": "¿Por qué hay poca presin en la ducha y no en el lavamanos?",
        ...
        "faq100_q_64": "¿Quées la smosis Inversa (RO)?",
        ...
        "faq100_q_87": "Cmo mitigar dao por agua rpido?",
        ...
        "pb_termás_title": "Trminos y Condiciones",
...
function clearProfileLocal() {
    if (confirm("Ests seguro de borrar toda la memoria del portal (Perfil, citas e historial de chat)?")) {
        ...
        const container = document.getElementById('joe-messages');
        if (container) {
            container.innerHTML = '<div class="msg bot">¡Hola! He borrado mi memoria de sesin. ¿En qué te puedo colaborar hoy? </div>';
        }
...
function clearJoeHistory() {
    if (confirm("Deseas vaciar el historial del chat con Joe?")) {
        ...
        const container = document.getElementById('joe-messages');
        if (container) {
            container.innerHTML = '<div class="msg bot">Entendido. Conversacin reiniciada. ¿En qué te puedo asistir hoy? </div>';
        }
