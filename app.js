...
const translations = {
    "en": {
        ...
        "svc_8_good_desc": "[EN] Instalacin de vlvula PRV de latn estndar de grado residencial. Estabiliza la presin principal previniendo daños a corto plazo.",
        ...
        "svc_14_best_desc": "[EN] Test in-situ más instalacin permanente de un medidor TDS digital en lnea en el fregadero de su cocina. Monitoreo en tiempo real de la pureza de su agua.",
        ...
        "eng_diseno_p1": "Morales Plumbing's Hydraulic Infrastructure Design is an advanced techúnical plumbing service that guarantees viability, efficiency, and scalability.",
        ...
        "hero_desc": "Integrating over 21 years of techúnical plumbing expertise with AI estimation and sustainable hydraulic design.",
        "stat_ready": "Licensed",
        "stat_eco": "ISO 14001",
        "stat_ai": "AI Active",
        ...
        "pb_prose_p1": "The ORION Price Book v6.0 PRO is the operational core of Morales Plumbing, designed to provide absolute transparency in cost techúnical plumbing. This catalog, updated to December 2024 for the California Bay Area, has been developed under the rigorous guidelines of the California Contractors State License Board (CSLB) and the Uniform Plumbing Code (UPC), ensuring that every techúnical intervention is backed by industrial safety and environmental sustainability standards.",
        ...
        "wh_prose_p1": "ORION THERMO CORE v2.0 is the dedicated management platform for high-efficiency tankless water heating systemás. Unlike traditional heaters, modern tankless units require precise combustion tuning and regular heat-exchanger descaling to maintain their 90%+ AFUE ratings. Thermo Core uses acoustic and flow sensors to detect the earliest signs of mineral accumulation.",
        ...
        "app_pricebook_detail": "The ORION Price Book v6.0 PRO is a cost techúnical plumbing tool that standardizes service rates across the Bay Area. It utilizes a tiered system (Good/Better/Best) to offer flexible options that comply with UPC safety standards.",
        ...
        "service_repair_desc": "Techúnical restoration via non-invasive thermography and acoustics.",
        ...
        "sec1_desc": "We move beyond traditional plumbing by integrating Sustainable Plumbing Systemás principles into every hydraulic design. We prioritize water efficiency, safe handling of hazardous materials (CSLB C-36 Compliance), and zero ecological impact systemás across the Bay Area.",
    ...
    "es": {
        ...
        "lp_f2": "100% Visual",
        "lp_f2_d": "Dise�o en tarjetas interactivas e ilustraciones t�cúnicas detalladas por Inteligencia Artificial.",
        "lp_f3": "Cero Riesgos",
        ...
        "htm_sink_desc": "Destapa tu lavamanos mec�únicamente.",
        ...
        "eng_valves_li3": "Calibraci�n Anti-¿Quéemaduras CPC: Ajuste exacto del l�mite de temperatura para seguridad familiar.",
        ...
        "pb_svc_4_tech": "Extracci�n de tuber�as galvanizadas, reemplazadas con cobre Tipo L utilizando uni�n mec�única ProPress cero llamas para una integridad superior.",
        ...
        "pb_svc_15_tech": "Medici�n ultras�única de espesor de tuber�as met�licas, validaci�n de refuerzo s�smico y pruebas de estr�s de todos los colectores primarios.",
        ...
        "svc_5_best_desc": "Inspecci�n HD y modelado. Mapeo completo del sistema, trazado de sonar y reporte de Plomer�a T�cúnica digital detallando pendientes, intrusiones y opciones de recubrimiento sin zanja (CIPP).",
        ...
        "law_sec1_p2": "<strong>�¿Qué�significa esto?</strong> A partir del 1 de enero de 2027, ser�ilegal vender o instalar nuevos calentadores de agua residenciales de gas natural que emitan NOx. Esto significa la eliminaci�n gradual completa de los calentadores tradicionales a gas en el Área de la Bah�a.",
        ...
        "pb_svc_9_better_mat": "¿Qué�mico espumante destructor de ra�ces (RootX), agentes desengrasantes.",
        ...
        "pb_svc_11_good_mat": "V�lvula S�smica Mec�única aprobada por California (ej. Little Firefighter), cinta de Tefl�n para gas.",
        ...
        "footer_print_watermark": "© MORALES PLUMBING 2026",
        "faq100_q_1": "�¿Por qué�es importante mantener la presi�n correcta en la propiedad?",
        ...
        "faq100_q_2": "�¿Qué�pasa si la presi�n del agua es muy alta?",
        ...
        "faq100_q_18": "�¿Por qué�me quedo sin agua caliente tan r�pido?",
        ...
        "faq100_q_22": "�¿Qué�son las tuber�as de PEX?",
        ...
        "faq100_q_25": "�¿Qué�es el 'golpe de ariete' y c�mo se soluciona?",
        ...
        "faq100_q_27": "�¿Qué�es el repipe (re-tuber�a)?",
        ...
        "faq100_q_32": "�¿Qué�causa ra�ces en la alcantarilla?",
        ...
        "faq100_q_35": "�¿Qué�es una inspecci�n con c�mara?",
        "faq100_a_35": "Es usar fibra �ptica para diagnosticar problemas subterr�neos sin necesidad de excavar.",
        "faq100_q_36": "�¿Qué�significa reparaci�n 'trenchless' (sin zanja)?",
        ...
        "faq100_q_47": "�¿Por qué�hay poca presi�n en la ducha y no en el lavamanos?",
        ...
        "faq100_q_59": "�¿Qué�hacer si se rompe la tuber�a debajo del fregadero?",
        ...
        "faq100_q_64": "�¿Qué�es la �smosis Inversa (RO)?",
        ...
        "faq100_q_72": "�¿Por qué�saber d�nde est�la v�lvula de paso?",
        ...
        "faq100_q_79": "�¿Qué�es una v�lvula reguladora t�rmica?",
        ...
        "faq100_q_91": "�¿Qué�es Plomer�a Inteligente (Smart Plumbing)?",
        ...
        "másg_membership_updated": "Membres�a actualizada a {tier}",
        ...
        "dash_feedback_desc": "Tu opini�n nos ayuda a retroalimentar la IA Joe y mejorar nuestra Plomer�a T�cúnica.",
        "feedback_rating": "Calificaci�n:",
        "btn_submit_feedback": "Enviar Valoraci�n",
        "schedule_title": "Agendar Nueva Cita T�cúnica",
        ...
        "btn_confirm_appointment": "Confirmar Cita de Plomer�a T�cúnica",
        ...
        "eng_diseno_code": "ENG-CENT-003",
        "eng_diseno_p1": "El Dise�o de Sistemas de Tuber�as de Morales Plumbing es un servicio avanzado de Plomer�a T�cúnica que garantiza la viabilidad, eficiencia y escalabilidad.",
        ...
        "eng_cobre_tech1_desc": "Empleamos t�cúnicas de uni�n mec�única sin fuego (ProPress) o soldadura de grado aeroespacial sin plomo.",
        ...
        "lbl_tech_specs": "Especificaciones T�cúnicas",
        "nav_back": " Volver al Cat�logo",
        "nav_nexus": "Nexus Inicio",
        "nav_orion": "Ecosistema Orion",
        "nav_services": "Plomer�a T�cúnica Pro",
        "nav_multimedia": "Podcasts",
        "nav_about": "Misi�n",
        "nav_terminal": "Terminal",
        "hero_badge": "Plomer�a T�cúnica PROFESIONAL Y CERTIFICACI�N CSLB C-36",
        "hero_title": "MORALES PLUMBING",
        "hero_desc": "Integrando m�s de 21 a�os de experiencia en Plomer�a T�cúnica con estimaci�n por IA y dise�o hidr�ulico sostenible.",
        "stat_ready": "Licenciado",
        "stat_eco": "ISO 14001",
        "stat_ai": "IA Activa",
        "hero_explore": "Ver Soluciones",
        "hero_joe": "Asistente Joe",
        "projects_title": "Excelencia en Plomer�a T�cúnica",
        ...
        "app_mp_desc": "Portal de comuúnicaci�n con el cliente y gesti�n inteligente de agendamiento.",
        ...
        "joe_status": "JOE: ASISTENTE DE Plomer�a T�cúnica AI",
        ...
        "app_pricebook_detail": "El Libro de Precios Orion v6.0 PRO es una herramienta de Plomer�a T�cúnica de costos que estandariza las tarifas de servicio en todo el Área de la Bah�a. Utiliza un sistema de niveles (Bueno/Mejor/Excelente) para ofrecer opciones flexibles que cumplen con los est�ndares de seguridad UPC.",
        "app_mp_detail": "El Portal Morales Plumbing (MP) centraliza la comuúnicaci�n con el cliente, permitiendo el agendamiento inteligente y el acceso a reportes t�cnicos generados por nuestra IA Joe. Garantiza transparencia total en cada fase del proyecto.",
        ...
        "service_copper_comp": "Superamos a la competencia que utiliza PEX de baja densidad y uniones mec�únicas propensas a fallas por presi�n.",
        "service_copper_plus": "Plomer�a T�cúnica Sostenible: Protocolos de sanitizaci�n post-instalaci�n y certificaci�n de soldadura sin plomo.",
        ...
        "service_construction_content": "Planificaci�n desde el nivel de cimentaci�n, rough-in de alta velocidad y acabados de Plomer�a T�cúnica premium.",
        ...
        "service_construction_costs": "Optimizaci�n del presupuesto mediante Plomer�a T�cúnica de valor y selecci�n estrat�gica de materiales.",
        ...
        "service_water_comp": "Dise�os personalizados frente a barriles de lluvia simples; nosotros entregamos Plomer�a T�cúnica de filtraci�n de grado 2.",
        "service_water_plus": "Plomer�a T�cúnica Sostenible: Sistemas de desinfecci�n UV integrados para prevenir la proliferaci�n de pat�genos.",
        ...
        "mission_desc": "Liderar la industria integrando m�s de 21 a�os de experiencia en Plomer�a T�cúnica con inteligencia artificial, ofreciendo soluciones de alta precisi�n bajo los est�ndares regulatorios de la CSLB y el C�digo Uniforme de Plomer�a (UPC).",
        "vision_title": "VISI�N",
        "vision_desc": "Ser el est�ndar global para la fontaner�a t�cúnica y la Plomer�a T�cúnica sostenible � definido por la innovaci�n constante, la excelencia operativa y la integridad absoluta en cada proyecto.",
        "terminal_title": "MORALES_EXECUTIVE_V1.0",
        ...
        "pb_termás_title": "T�rminos y Condiciones",
        ...
        "cat_eco": "Sostenible",
        "cat_techúnical plumbing": "Plomer�a T�cúnica",
        ...
        "pb_method_p1": "La metodolog�a de c�lculo de ORION se basa en un enfoque de Plomer�a T�cúnica de precisi�n para el costeo hidr�ulico. Utilizamos algoritmos de grado industrial que consideran la durabilidad del material, la intensidad de la mano de obra (categorizada por roles de L�der y Ayudante) y la complejidad t�cúnica. Esto elimina la variabilidad de la estimaci�n, proporcionando una estructura de tarifa fija alineada con los est�ndares de la CSLB y la volatilidad del mercado de la construcci�n en California.",
        "pb_method_p2": "Al integrar datos de la cadena de suministro en tiempo real y protocolos de flujo de trabajo de marca propia altamente eficientes, nuestra metodolog�a garantiza un margen optimizado del 30% mientras mantiene m�rgenes sostenibles para una ejecuci�n t�cúnica de alta fidelidad. Este enfoque cient�fico de fijaci�n de precios asegura que cada proyecto est�respaldado por datos hidr�ulicos verificados y una asignaci�n transparente de recursos.",
        "pb_tiers_p1": "El sistema Bueno/Mejor/Excelente proporciona a nuestros clientes tres niveles distintos de soluciones de Plomer�a T�cúnica, adaptados a los diferentes objetivos del ciclo de vida del proyecto. El nivel 'Bueno' se centra en reparaciones que cumplen con el UPC y una restauraci�n eficiente. El nivel 'Mejor' introduce una mayor durabilidad de los componentes y mejoras de rendimiento de rango medio. El nivel 'Excelente' representa el est�ndar de ORION Tech: materiales premium de grado industrial, monitoreo integrado por IA y garant�as de ciclo de vida extendidas.",
        ...
        "pb_promo_p1": "El marco de promociones de Morales Plumbing recompensa el mantenimiento proactivo y los compromisos de proyectos de gran volumen. Ofrecemos incentivos peri�dicos para el cambio de tuber�as en todo el hogar, optimizaciones estacionales de calentadores de agua e integraciones de ORION Tech por primera vez. Estas promociones est�n dise�adas para reducir la barrera de entrada a soluciones de Plomer�a T�cúnica de alta precisi�n.",
        "pb_promo_p2": "Todas las promociones activas est�n sujetas a revisi�n de Plomer�a T�cúnica y no pueden combinarse con otros descuentos estrat�gicos, asegurando que la calidad del proyecto siga siendo la prioridad absoluta.",
        "pb_termás_p1": "Todos los servicios proporcionados por Morales Plumbing se rigen por la Junta de Licencias del Estado de Contratistas de California (CSLB) y el C�digo Uniforme de Plomer�a (UPC). Cada contrato incluye un alcance detallado del trabajo, precios de tarifa fija (sin tarifas ocultas) y una declaraci�n clara de la metodolog�a t�cúnica. Los pagos est�n estructurados para alinearse con los hitos del proyecto.",
        "pb_termás_p2": "La responsabilidad y la resoluci�n de disputas siguen los est�ndares industriales de California, asegurando una asociaci�n profesional y transparente entre el equipo de Plomer�a T�cúnica y el cliente.",
        "pb_warranty_p1": "Morales Plumbing ofrece una garant�a est�ndar de 1 a�o en toda la mano de obra e integraciones t�cúnicas, con garant�as extendidas disponibles para sistemas de nivel 'Excelente' e instalaciones de ORION Tech. Adem�s, contamos con planes de cr�dito y sistemas de garant�a en mano de obra de por vida con repipe completo, ya sea de agua, drenaje o gas. Nuestro equipo de soporte utiliza datos de monitoreo de IoT para proporcionar respuestas de diagn�stico r�pidas, minimizando el tiempo de inactividad y asegurando la integridad del sistema.",
        ...
        "pb_prose_p3": "Nuestro enfoque integra estimaciones impulsadas por IA con m�s de 21 a�os de experiencia en el campo, lo que permite una tasa de precisi�n del 99% en la asignaci�n de recursos y la proyecci�n de plazos. Al elegir ORION, est�eligiendo un socio de infraestructura estrat�gica comprometido con los niveles m�s altos de excelencia t�cúnica e integridad.",
        "aq_title": "ORION AQUA GUARD v1.0",
        ...
        "hn_prose_p3": "Hydraulic Nexus tambi�n se integra con nuestros diagn�sticos de termograf�a, permiti�ndonos superponer datos t�rmicos en tiempo real sobre los planos originales para una detecci�n de fugas y auditor�a de infraestructura precisas. Es la herramienta definitiva para la Plomer�a T�cúnica Avanzada de precisi�n.",
        "wh_title": "ORION THERMO CORE v2.0",
        ...
        "service_expansion_detail": "CONTENIDO: Bloques de expansi�n hidr�ulica modular. PROP�SITO: Integraci�n perfecta de nuevos accesorios sin p�rdida de presi�n. USO: Adiciones comerciales y ampliaciones residenciales. POTENCIALIDADES: Escalabilidad infinita. COSTOS: Evita el redise�o total del sistema. PLUS: Plomer�a T�cúnica avanzada y procesos Lean. COPYRIGHT: © 2026 Morales Plumbing. Todos los derechos reservados.",
        "service_construction_title": "Plomer�a T�cúnica de Obra Nueva",
        "service_construction_desc": "Dise�o y despliegue integral de infraestructura para edificios inteligentes.",
        "service_construction_detail": "CONTENIDO: Planos CAD, Rough-in y acabados de lujo. PROP�SITO: Excelencia t�cúnica desde cero. USO: Nuevos edificios residenciales y comerciales. POTENCIALIDADES: Valorizaci�n inmediata de la propiedad. COSTOS: Optimizaci�n de materiales mediante Lean Process. PLUS: Protocolos Ambientales Internacionales. COPYRIGHT: © 2026 Morales Plumbing. Todos los derechos reservados.",
        "service_repair_title": "Diagn�stico y Reparaci�n Smart",
        "service_repair_desc": "Restauraci�n t�cúnica mediante termograf�a y ac�stica no invasiva.",
        ...
        "service_water_desc": "Plomer�a T�cúnica de captura de lluvia y reutilizaci�n de aguas grises estrat�gicas.",
        ...
        "faq_a5": "Combina la experiencia CSLB C-36 con Plomer�a T�cúnica Sostenible, diagn�sticos por IA y Proceso Lean, brindando un nivel de precisi�n y sostenibilidad inigualable.",
        "faq_q6": "�C�mo asegura Morales Plumbing el cumplimiento del UPC?",
        "faq_a6": "Nuestros ingenieros cuentan con certificaci�n CSLB C-36 y utilizan protocolos de verificaci�n por IA para asegurar que cada conexi�n supere los est�ndares de California. Adem�s, ofrecemos inspecciones f�sicas tradicionales de doble inspector y listas de verificaci�n manuales para clientes que prefieren la supervisi�n mec�única cl�sica. <span class=\"comic-choice\">La decisi�n es suya</span>: elija nuestra validaci�n digital de alta precisi�n asistida por IA, o nuestra inspecci�n humana manual probada en el tiempo con garant�as mec�únicas.",
        "faq_q7": "�¿Qué�m�tricas 'Lean' espec�ficas rastrean?",
        ...
        "lbl_tech_view": "Esp. T�cúnica & Materiales (3 Niveles):",
        "profile_header_role": "Liderazgo en Plomer�a T�cúnica",
    ...
    "zh": {
        ...
        "svc_5_best_desc": "[EN] Inspecci�n HD y modelado. Mapeo completo del sistema, trazado de sonar y reporte de Plomer�a T�cúnica digital detallando pendientes, intrusiones y opciones de recubrimiento sin zanja (CIPP).",
    ...
    "vi": {
        ...
        "law_sec1_p1": "¿Quéận ¿Quéản lý Chất lượng Không kh�Khu vực Vịnh (BAAQMD) đã ban hành một sửa đổi lịch sử để giảm ô nhiễm nitơ oxit (NOx).",
        ...
        "law_sec3_li4": "<strong>Van T&P (Van xả Nhiệt độ & Áp suất):</strong> ¿Quéan trọng đối với an toàn, đường xả của n�phải dẫn nước n�ng đến cống một c�ch an toàn, thường là ngoài trời.",
        "law_btn_back": "Xem c�c G�i Lắp đặt được Chứng nhận",
        "btn_eco_systemás": "⚡ Hệ thống m�y nước n�ng Eco",
        "promo_wp_title": "2027 Zero-NOx Mandate: Heat Pump Water Heaters",
        "promo_wp_desc": "Ensure compliance with BAAQMD Regulation 9, Rule 6. Transition to ultra-efficient electric Heat Pump Water Heaters before the 2027 deadline.",
        "btn_upgrade": "View Plans",
        "promo_wp_why_title": "Why Upgrade Now?",
        ...
        "eng_diseno_tech3_desc": "Sự chấp thuận được đảm bảo trong c�c cuộc kiểm tra của thành phố nhờ việc tuân thủ nghiêm ngặt c�c ¿Quéy định Lắp đặt Ống nước Thống nhất và của California.",
        ...
        "eng_septico_tech3_desc": "¿Quéản lý giấy ph�p từ đầu đến cuối, đảm bảo thiết kế vượt qua c�c yêu cầu về sức khỏe và giảm bớt c�c khoản tiền phạt.",
        ...
        "faq_a1": "Đồng cung cấp độ bền vượt trội, khả năng chống ch�y và ngăn ngừa vi khuẩn ph�t triển. Theo UPC California, n�vẫn là tiêu chuẩn vàng cho gi�trị cao cấp. Mặt kh�c, PEX mang lại sự linh hoạt vượt trội, �t mối nối hơn (giảm thiểu điểm rò rỉ), thời gian lắp đặt nhanh hơn và chi ph�vật liệu ban đầu thấp hơn. <span class=\"comic-choice\">¿Quéyết định là của bạn</span>: chọn độ bền cao cấp và gi�trị vật liệu cổ điển (Đồng), hoặc hiệu quả chi ph�hiện đại và khả năng phục hồi đàn hồi (PEX).",
        "faq_q2": "C�c quy định về bể tự hoại và môi trường năm 2026 của California là gì?",
        "faq_a2": "C�c quy định tập trung vào giảm nitơ, bảo vệ nước ngầm và hiệu quả t�i sử dụng nước. Morales Plumbing đảm bảo tuân thủ 100% thông qua kỹ thuật môi trường tiên tiến và c�c giao thức của Ban Nước. Ngoài ra, ch�ng tôi thiết kế c�c hệ thống bể tự hoại tuân thủ tiêu chuẩn gi�p giảm thiểu chi ph�ban đầu bằng c�c lộ trình cấp ph�p truyền thống. <span class=\"comic-choice\">¿Quéyết định là của bạn</span>: đầu tư vào hệ sinh th�i tiên tiến để đ�n đầu tiêu chuẩn 2030, hoặc chọn cấu hình tiêu chuẩn tập trung vào tiết kiệm chi ph�trước mắt.",
        "faq_q3": "¿Quéy trình Lean và Kỹ thuật Môi trường c�lợi gì cho dự �n của tôi?",
        "faq_a3": "Bằng c�ch loại bỏ lãng ph�và sử dụng vật liệu bền vững, ch�ng tôi giảm 25% chi ph�và 30% thời gian thực hiện. C�c giao thức của ch�ng tôi đảm bảo lượng kh�thải carbon thấp hơn và ROI cơ sở hạ tầng cao hơn. Hoặc ch�ng tôi cung cấp c�c phương ph�p xây dựng cổ điển tập trung vào đặc điểm tùy chỉnh tối đa và dự phòng cấu tr�c thủ công tuyệt đối mà không bị giới hạn tiến độ Lean. <span class=\"comic-choice\">¿Quéyết định là của bạn</span>: chọn quy trình Lean sinh th�i tăng tốc để tối đa h�a hiệu quả, hoặc xây dựng thủ công cổ điển để c�biên độ tùy chỉnh truyền thống.",
...
async function callGemini(apiKey) {
    ...
    const contents = [
        ...
        { role: 'model', parts: [{ text: 'Entendido! Soy Joe, el asistente IA de Morales Plumbing. ¿En quéte ayudo?' }] },
        ...joeHistory.map(m => ({
...
function getJoeLocalFallback(input) {
    if (input.match(/hola|hello|hi|buenos|saludos/)) return "¡Hola! Soy Joe, el asistente IA de Morales Plumbing. ¿Cómo te puedo ayudar hoy con tu infraestructura hidrulica? ";
    if (input.match(/precio|price|cuanto|cost|cotizaci/)) return "Contamos con el ORION PRICE BOOK v6.0 PRO, que incluye +100 Servicios Profesionales con 3 niveles de Plomería Técúnica (Good/Better/Best). Puedes ver el catálogo en la seccin 'Ecosistema'.";
...
�Cu�l es tu **nombre completo**?`,
        ...
        '✅ Entendido. �¿Qué�**tipo de servicio** necesitas? (Ej: Water heater, detecci�n de fugas, repipe, drain cleaning...)',
...
Nos comuúnicaremos contigo al ${d.phone} para confirmar. Tu informaci�n est�protegida bajo est�ndares CCPA. �Gracias, ${d.name}! `
