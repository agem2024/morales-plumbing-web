...
const translations = {
    ...
    "es": {
        ...
        "lp_feat_title": "¿QuéIncluye Nuestro Hub Visual?",
        "lp_f1": "Lista Exacta",
        ...
        "lp_a1": "Absolutamente no. Todas las guas de este portal fueron curadas asumiendo que nunca has tocado una pinza en tu vida. Empezamos desde lo más bsico.",
        ...
        "lp_a3": "Todas las guas inician con el paso de seguridad más importante (como cerrar la llave de paso). Si algo sale mal, tu casa estsegura. Adems, nuestro asistente Joe AI estdisponible para ayudarte.",
        ...
        "diy_gfi_desc": "Sin energa en el triturador? Prueba este rápido reinicio elctrico.",
        ...
        "svc_1_good_desc": "Resolucin mediante un diagnóstico visual y acstico bsico. Se emplea un parche estndar y equipo manual para fugas accesibles. Ideal para reparaciones rpidas de bajo impacto.",
        ...
        "svc_3_best_desc": "Halo 5 Whole House System. Sistema sin sal que no requiere mantenimiento, filtra cloro, metales pesados e incluye un mdulo de esterilización UV para proteccin bacteriolgica total.",
        ...
        "svc_8_good_desc": "Instalacin de vlvula PRV de latn estndar de grado residencial. Estabiliza la presión principal previniendo daos a corto plazo.",
        ...
        "svc_14_good_desc": "Test rápido in-situ. Medicin de TDS (Slidos Disueltos Totales), prueba de dureza por gotas qumicas y nivel de cloro libre.",
        ...
        "law_sec2_p1": "Comprender las tecnologas aprobadas para la transicin energética de California es vital para cumplir con el Título 24 (Title 24).",
        ...
        "faq100_q_72": "¿Por qué saber dnde estla vlvula de paso?",
        ...
        "faq100_q_87": "Cmo mitigar dao por agua rápido?",
        ...
        "pol_quality_text": "Garantizamos la mxima calidad de instalación y servicio a travs de un estricto protocolo de doble inspeccin. Para asegurar la durabilidad del sistema a largo plazo, Morales Plumbing ofrece a sus afiliados Estndar 1 inspeccin preventiva anual gratuita (deteccin de fugas o lavado de calentador de agua) y a sus afiliados Premium 2 inspecciones preventivas anuales gratuitas (cmara SeeSnake en drenajes, anlisis qumico de agua, calibracin de PRV o termografa). Todo el trabajo cumple con el Cdigo Uniforme de Plomera (UPC).",
        ...
        "hero_title": "MORALES PLUMBING",
        "hero_desc": "Integrando más de 21 aos de experiencia en Plomera Tcúnica con estimacin por IA y diseo hidrulico sostenible.",
        ...
        "app_redes_detail": "Software de diseo hidrulico con integracin CAD que permite modelar flujos, presiones y gradientes trmicos. Esencial para infraestructura de alta complejidad en el ÁÁrea de la Bahía.",
        ...
        "mission_title": "MISIN",
        "mission_desc": "Liderar la industria integrando más de 21 aos de experiencia en Plomera Tcúnica con inteligencia artificial, ofreciendo soluciones de alta precisin bajo los estándares regulatorios de la CSLB y el Cdigo Uniforme de Plomera (UPC).",
        "vision_title": "VISIN",
        ...
        "pb_method_p1": "La metodologa de clculo de ORION se basa en un enfoque de Plomera Tcúnica de precisin para el costeo hidrulico. Utilizamos algoritmos de grado industrial que consideran la durabilidad del material, la intensidad de la mano de obra (categorizada por roles de Lder y Ayudante) y la complejidad tcúnica. Esto elimina la variabilidad de la estimacin, proporcionando una estructura de tarifa fija alineada con los estándares de la CSLB y la volatilidad del mercado de la construccin en California.",
        ...
        "pb_termás_p2": "La responsabilidad y la resolucin de disputas siguen los estándares industriales de California, asegurando una asociacin profesional y transparente entre el equipo de Plomera Tcúnica y el cliente.",
        "pb_warranty_p1": "Morales Plumbing ofrece una garanta estndar de 1 ao en toda la mano de obra e integraciones tcúnicas, con garantas extendidas disponibles para sistemas de nivel 'Excelente' e instalaciones de ORION Tech. Adems, contamos con planes de crdito y sistemas de garanta en mano de obra de por vida con repipe completo, ya sea de agua, drenaje o gas. Nuestro equipo de soporte utiliza datos de monitoreo de IoT para proporcionar respuestas de diagnóstico rpidas, minimizando el tiempo de inactividad y asegurando la integridad del sistema.",
        ...
        "faq_a1": "El cobre proporciona una durabilidad superior, resistencia al fuego y previene el crecimiento bacteriano. Bajo el UPC de California, sigue siendo el estndar de oro para el valor de alta gama. Por otro lado, el PEX ofrece una flexibilidad excepcional, menos conexiones de unin (reduciendo puntos de fuga), instalación más rpida y menores costos iniciales de material. <span class=\"comic-choice\">La decisin es suya</span>: elija la longevidad premium y el valor clsico del cobre, o la rentabilidad moderna y la resiliencia elstica del PEX.",
