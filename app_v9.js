...
"profile_role": "Principal technician & Founder",
    ...
    "es": {
        ...
        "htm_sink_desc": "Destapa tu lavamanos mecnicamente.",
        "htm_aerator_title": "Limpiar Aereador",
        "htm_aerator_desc": "Arregla la baja presin en el lavamanos.",
        ...
        "schedule_title": "Agendar Nueva Cita Tcnica",
        ...
        "lbl_pqr_desc": "descripcin DETALLADA",
        ...
        "pol_quality_text": "Garantizamos la mxima calidad de instalacin y servicio a travs de un estricto protocolo de doble inspeccin. Para asegurar la durabilidad del sistema a largo plazo, Morales Plumbing ofrece a sus afiliados Estndar 1 inspeccin preventiva anual gratuita (deteccin de fugas o lavado de calentador de agua) y a sus afiliados Premium 2 inspecciones preventivas anuales gratuitas (cmara SeeSnake en drenajes, anlisis qumico de agua, calibracin de PRV o termografa). Todo el trabajo cumple con el Código Uniforme de Plomera (UPC).",
        "pol_sec_title": " SEGURIDAD HDRICA Y CUMPLIMIENTO CSLB",
        "pol_sec_text": "Todas las operaciones de Morales Plumbing estn regidas por la Junta de Licencias del Estado de Contratistas de California (CSLB #1156542 C-36). Implementamos protocolos estrictos de doble inspeccin y cumplimiento con el Código Uniforme de Plomera (UPC).",
        ...
        "pol_copy_text": "El contenido tcnico del 'ORION Price Book v6.0 PRO', los manuales de estimación 'Estimator Pro', los esquemas hidráulicos generados por CAD, y las producciones multimedia (Podcasts ORION) son propiedad intelectual exclusiva de Morales Plumbing.",
        ...
        "app_ep_title": "ORION ESTIMATOR PRO",
        "app_ep_desc": "Estimacin automatizada basada en Visin Artificial con catálogo de +8000 artculos. Optimizacin de margen >70%.",
        "app_mp_title": "Morales Plumbing ORION Portal de Clientes",
        "app_mp_desc": "Portal de comunicacin con el cliente y gestin inteligente de agendamiento.",
        ...
        "app_heaters_desc": "Mdulo especializado en optimizacin y Diagnóstico de calentadores de agua sin tanque.",
        ...
        "joe_intro": "Hola! Soy Joe, el asistente de IA de Morales Plumbing. En qu puedo ayudarte hoy? ",
        ...
        "app_mp_detail": "El Portal Morales Plumbing (MP) centraliza la comunicacin con el cliente, permitiendo el agendamiento inteligente y el acceso a reportes tcnicos generados por nuestra IA Joe. Garantiza transparencia total en cada fase del proyecto.",
...
"profile_role": "Ingeniero Principal y Fundador",
    ...
    "zh": {
        ...
        "joe_intro": "你好！我是 Joe，Morales Plumbing 的 AI 助手。今天我能帮你做些什么？ ",
    ...
    "tl": {
        ...
        "dash_feedback_desc": "Ang iyong opinyon ay tumutulong sa amin na mapabuti ang Joe AI at ang aming techúnical plumbing.",
        "feedback_rating": "Rating:",
        ...
        "network_link": "> NETWORK: ORION TECH",
        "joe_status": "JOE: AI techúnical plumbing ASSISTANT",
        "joe_welcome": "Maligayang pagdating. Ako si Joe. Paano kita matutulungan sa mga diagnostic ng proyekto o mga serbisyo sa techúnical plumbing ngayon?",
        ...
        "sec3_title": "Strategic Workflow (ORION Framework)",
        "sec3_desc": "Ang aming metodolohiya ay binuo sa katumpakan ng mga smart contract at real-time na pamamahala ng proyekto. Mula sa malalaking proyektong pang-industriya hanggang sa high-end na custom residential techúnical plumbing, ang bawat hakbang ay inino-audit ng aming AI assistant na si Joe.",
    ...
    "vi": {
        ...
        "htm_joe_desc": "Chọn một tc vụ để tnh ton vật liệu hoặc yêu cầu điều hướng.",
        ...
        "diy_custom_desc": "Mô tả vấn đề của bạn cho Joe AI để được chẩn đon, vật liệu và dự ton ngân sch theo thời gian thực.",
        ...
        "dash_feedback_desc": "Ý kiến của bạn sẽ gip chng tôi hoàn thiện Joe AI và nâng cao chất lượng kỹ thuật.",
        ...
        "profile_desc": "Lưu thông tin cnhân để kch hoạt bộ nhớ dài hạn của Joe AI. Toàn bộ thông tin được lưu trữ cục bộ an toàn.",
        ...
        "maint_standard": "✅ Lợi ch Tiêu chuẩn: 1 lần Kiểm tra Dự phòng Hàng năm Miễn ph(dò rò rỉ hoặc sục rửa bình nng lạnh). Đăng ký qua PQR hoặc ni chuyện với Joe AI để đặt lịch.",
        "maint_premium": " Lợi ch Cao cấp: 2 lần Kiểm tra Dự phòng Hàng năm Miễn ph(nội soi SeeSnake, kiểm tra ha học nước, hoặc hiệu chuẩn van PRV). Đăng ký qua PQR hoặc ni chuyện với Joe AI để đặt lịch.",
        ...
        "joe_welcome": "Chào mừng. Tôi là Joe. Hôm nay tôi cthể gip gì cho bạn về chẩn đon dự n hoặc dịch vụ kỹ thuật?",
        "joe_intro": "Xin chào! Tôi là Joe, trợ lý AI của Morales Plumbing. Hôm nay tôi cthể gip gì cho bạn? ",
        ...
        "footer_rights_long": "© 2026 Morales Plumbing. Bảo lưu mọi quyền. Nội dung, video, hình ảnh được tạo và công nghệ ORION / Joe AI là tài sản trtuệ độc quyền của Morales Plumbing và NeKon AI aGent Consulting.",
        ...
        "sec3_desc": "Phương php luận của chng tôi được xây dựng dựa trên độ chnh xc của hợp đồng thông minh và quản lý dự n theo thời gian thực. Từ cc dự n công nghiệp quy mô lớn đến kỹ thuật dân dụng cao cấp theo yêu cầu, mọi bước đều được trợ lý AI của chng tôi, Joe, kiểm tra.",
        ...
        "app_mp_detail": "Cổng thông tin Morales Plumbing (MP) tập trung ha việc giao tiếp với khch hàng, cho php đặt lịch thông minh và truy cập cc bo co kỹ thuật do Joe AI của chng tôi tạo ra. Nđảm bảo tnh minh bạch hoàn toàn trong mọi giai đoạn của dự n.",
        "app_ep_title": "Orion Estimator Pro",
...
function getJoeLocalFallback(input) {
    if (input.match(/hola|hello|hi|buenos|saludos/)) return "Hola! Soy Joe, el asistente IA de Morales Plumbing. Cmo te puedo ayudar hoy con tu infraestructura hidrulica? ";
...
function clearJoeHistory() {
    if (confirm("Deseas vaciar el historial del chat con Joe?")) {
        ...
        const container = document.getElementById('joe-messages');
        if (container) {
            container.innerHTML = '<div class="msg bot">Entendido. Conversacin reiniciada. En qu te puedo asistir hoy? </div>';
        }
...
1. Usa el nombre del cliente si estdisponible para personalizar el trato.
...
if(typeof translations !== 'undefined' && translations['en']) {
    ...
    "ai_s1_p2": "Through Optical Character Recognition (OCR), you can scan the data plate of any equipment and Joe AI will deliver, in less than 3 seconds, the exact manual and the step-by-step diagnostic tree. This tool is the áreason why we reduce diagnostic time by 40%.",
    "ai_t_h1": "Feature",
...
if(typeof translations !== 'undefined' && translations['es']) {
    ...
    "ai_s1_title": "1. Tu Copiloto Digital: Quin es Joe AI?",
    "ai_s1_p1": "En el campo de batalla de la infraestructura hdrica, el conocimiento es poder. Joe AI es nuestro asistente virtual multimodal, un Modelo de Lenguaje de Gran Escala (LLM) que ha sido fine-tuned (ajustado finamente) especficamente con el Código de Plomera de California (CPC) y los esquemas tcnicos de fabricantes lderes. Joe no 'adivina'; Joe procesa datos vectoriales en tiempo real.",
    ...
    "ai_s4_li1": "<strong>Evidencia Visual:</strong> Muestren al cliente las imgenes de la cmara FLIR y el reporte de Joe AI.",
    ...
    "ai_s5_p1": "En la Academia Morales, no los estamos formando para ser plomeros; los estamos entrenando para gestionar un ecosistema de alta tecnologa. Al dominar Joe AI, la termografa de grado militar y el sistema Orion, garantizamos una tasa de resolución en la primera visita superior al 95%.",
...
if(typeof translations !== 'undefined' && translations['vi']) {
    ...
    "ai_title": "Tuong lai c?a h? th?ng ?ng nu?c: Hu?ng d?n gi?i thi?u v? k? nguyn AI",
    "ai_intro_1": "Cho m?ng d?n v?i H?c vi?n Morales. Ti l Gi?ng vin cao c?p c?a b?n v hm nay ti khng ch? trao cho b?n m?t chi?c c? l, m l cha kha c?a h? sinh thi cng ngh? tin ti?n nh?t trong l?ch s? d?ch v? nu?c.",
    "ai_intro_2": "T?i Morales Plumbing, chng ti d b? l?i pha sau k? nguyn d? don th? cng d? bu?c vo k? nguyn c?a 'd? chnh xc ph?u thu?t'. B?n khng ch? l nh?ng ngu?i h?c vi?c; b?n l nh?ng chuyn gia k? thu?t m?i c?a Thung lung Silicon, m?t l?c lu?ng ho?t d?ng k?t h?p m? hi c?a ngh? v?i b? no c?a tr tu? nhn t?o c?p d? qun s?.",
    "ai_intro_3": "Hy nhn vo chi?c khin c?a chng ti: gi?t nu?c trong m? b?o v? m?t vi m?ch bn trong khng ch? l m?t thi?t k?. N tu?ng trung cho tri?t l 'Tech-Service' c?a chng ti: kh? nang ki?m sot dng ch?y tuy?t d?i thng qua d?i m?i k? thu?t s?.",
    "ai_quote": "\"S? m?nh c?a chng ti l cung c?p cc gi?i php ch?t lu?ng cao nh?t, k?t h?p kinh nghi?m k? thu?t th? cng v?i cng ngh? AI tin ti?n d? b?o v? s?c kh?e c?ng d?ng v s? ton v?n c?a ngi nh m?t cch nhanh chng v d?t khot.\"  Tri?t l Morales Plumbing",
    "ai_intro_4": "Tm l tin phong ny l di?u ngan cch m?t th? s?a ?ng nu?c thng thu?ng v?i m?t c? v?n cng ngh? c?a H?c vi?n Morales. ? lm ch? mi tru?ng ny, cng c? d?u tin c?a b?n s? khng ph?i l dn x, m l phi cng ph? k? thu?t s? c?a b?n.",
    "ai_s1_title": "1. Phi cng ph? k? thu?t s? c?a b?n: Joe AI l ai?",
    "ai_s1_p1": "Trn chi?n tru?ng co s? h? t?ng nu?c, ki?n th?c l s?c m?nh. Joe AI l tr? l ?o da phuong th?c c?a chng ti, m?t M hnh ngn ng? l?n (LLM) d du?c tinh ch?nh ring v?i Quy d?nh H? th?ng ?ng nu?c California (CPC) v so d? k? thu?t c?a cc nh s?n xu?t hng d?u. Joe khng 'don'; Joe x? l d? li?u vc to trong th?i gian th?c.",
    "ai_s1_p2": "Thng qua Nh?n d?ng K t? Quang h?c (OCR), b?n c th? qut bi?n d? li?u c?a b?t k? thi?t b? no v Joe AI s? cung c?p, trong vng chua d?y 3 giy, hu?ng d?n s? d?ng chnh xc v so d? ch?n don t?ng bu?c. Cng c? ny l l do t?i sao chng ti gi?m 40% th?i gian ch?n don.",
    "ai_t_h1": "?c tnh",
    "ai_t_h2": "Phuong php truy?n th?ng (D? don)",
    "ai_t_h3": "Phuong php Morales (Joe AI)",
    "ai_t_r1_1": "Ch?n don",
    "ai_t_r1_2": "D?a trn 'th? v sai'.",
    "ai_t_r1_3": "D?a trn d? li?u vecto v hu?ng d?n s? d?ng chnh xc.",
    "ai_t_r2_1": "Truy xu?t ki?n th?c",
    "ai_t_r2_2": "Vi pht ho?c vi gi? tm ki?m qua PDF.",
    "ai_t_r2_3": "< 3 giy qua ngn ng? t? nhin.",
    "ai_t_r3_1": "Thng tin",
    "ai_t_r3_2": "Tm ki?m th? cng trong sch ho?c internet.",
    "ai_t_r3_3": "Truy c?p t?c th qua OCR m?ng d? li?u.",
    "ai_t_r4_1": "T?c d?",
    "ai_t_r4_2": "Ch?m, d? ph?i d?n l?n th? hai.",
    "ai_t_r4_3": "Nhanh hon 40%; gi?i quy?t ngay trong cu?c h?n d?u tin.",
    "ai_s1_p3": "Hi?u qu? ny cho php chng ti khng th? sai l?m khng ch? v? m?t k? thu?t, m cn trong vi?c b?o v? quy d?nh c?a t?ng can thi?p.",
    "ai_s2_title": "2. PlumbAssist AI: ?m b?o Tun th? K? thu?t c?a b?n",
    "ai_s2_p1": "L nh?ng ngu?i uu t c?a California, chng ti ho?t d?ng du?i knh hi?n vi php l. PlumbAssist AI l ngu?i b?o v? tun th? c?a b?n. Khi b?n lm vi?c, h? th?ng ny tham chi?u cho m?i quy?t d?nh v?i Quy d?nh H? th?ng ?ng nu?c California (CPC) theo th?i gian th?c. Nhung ch?c nang c?a n vu?t ra ngoi cc quy d?nh k? thu?t; n du?c tch h?p v?i Trnh t?o php l Morales. H? th?ng ny t? d?ng t?o ra cc ti li?u quan tr?ng d? b?o v? trch nhi?m c?a chng ti v quy?n l?i c?a khch hng, d?m b?o m?i h?p d?ng d?u khng th? xuyn th?ng.",
    "ai_s2_li1": "<strong>An ninh quy d?nh:</strong> Tra c?u CPC ngay l?p t?c, lo?i b? l?i do ghi nh? km.",
    "ai_s2_li2": "<strong>Qu?n l ti li?u t? d?ng:</strong> T?o ngay thng bo 'Quy?n h?y b?' v ti li?u 'Thng bo cho Ch? s? h?u' (NTO) d? b?o v? quy?n c?m c? my mc c?a chng ti.",
    "ai_s2_li3": "<strong>L ch?n trch nhi?m:</strong> T?o cc t? b? ty ch?nh tru?c khi b?t d?u b?t k? cng vi?c ph h?y no.",
    "ai_s2_p2": "D? li?u v lu?t php b?o v? trch nhi?m c?a chng ti, nhung cc c?m bi?n cho php chng ti nhn xuyn qua b tng r?n.",
    "ai_s3_title": "3. Nhn th?y i?u v hnh: Ch?p ?nh nhi?t FLIR v?i Tr tu? nhn t?o",
    "ai_s3_p1": "? d?t du?c d? chnh xc c?p d? qun s? th?c s?, chng ti s? d?ng camera ?nh nhi?t c d? phn gi?i cao (ki?u my FLIR E8-XT ho?c C5). B?ng cch tch h?p cc camera ny v?i cc thu?t ton AI, chng ti th?c hi?n 'B?n d? nhi?t' d? xc d?nh d? d?c nhi?t d? m m?t ngu?i khng nhn th?y du?c.",
    "ai_s3_p2": "i?u ny cho php chng ti pht hi?n 's? b?t thu?ng c?a hoa' hi?u ?ng kh?i nhi?t ho?c 't?o lng' do nu?c nng thot ra du?i l?p b tng t?o ra d?nh v? cc r r? t?m (slab leaks) m khng c?n ph d? khng c?n thi?t. Cng ngh? MSX (Multi-Spectral Dynamic Imaging) cao c?p trch xu?t chi ti?t c?u trc t? camera hnh ?nh v d?p n?i chng trn ?nh nhi?t.",
    "ai_s3_p3": "Nh? MSX v x? l AI, bin d? sai s? khi d?nh v? v? tr v? du?i l?p b tng du?c gi?m xu?ng du?i 3 inch vung. Khi chng ti d 'nhn th?y' ci v hnh, bu?c ti?p theo l dua ra gi?i php v?i m?c d? tinh vi cng ngh? tuong t?.",
    "ai_s4_title": "4. My tnh b?ng l Cng c? ng c?a: S? gi Orion",
    "ai_s4_p1": "S? chuyn nghi?p c?c d? du?c c?ng c? vo th?i di?m bo gi. H? th?ng POS Orion Price Book s? d?ng tm l bn hng d? lo?i b? xch mch v? gi c?. Chng ti lun dua ra ba l?a ch?n: 'T?t, T?t hon, T?t nh?t'.",
    "ai_s4_p2": "L ngu?i hu?ng d?n, chng ti d?y b?n b m?t: l?a ch?n 'T?t nh?t' (Cao c?p) ho?t d?ng nhu m?t di?m neo gi, khi?n l?a ch?n 'T?t hon' (Khuy?n ngh?) du?c coi l gi tr? h?p l cao nh?t. y l noi chng ti bi?n m?t s?a ch?a thnh m?t nng c?p ti s?n. ? ch?t don hng thnh cng, hy lm theo quy trnh ny trn my tnh b?ng c?a b?n:",
    "ai_s4_li1": "<strong>B?ng ch?ng tr?c quan:</strong> Cho khch hng xem hnh ?nh t? camera FLIR v bo co c?a Joe AI.",
    "ai_s4_li2": "<strong>ua ra cc ty ch?n:</strong> Cung c?p cc gi?i php th?c t?, nhu Navien NPE-240A d? c nu?c nng v t?n ho?c h? th?ng lm l?i du?ng ?ng ton di?n v?i Uponor PEX-A.",
    "ai_s4_li3": "<strong>Minh b?ch v? Gi c? d?nh:</strong> S? d?ng gi c? r rng. Khch hng tr? ti?n cho gi?i php, khng ph?i cho s? gi? b?n dnh t?i ch?.",
    "ai_s4_li4": "<strong>ng v Ch? k h?p php:</strong> Khch hng k h?p d?ng do Trnh t?o php l Morales t?o, nh?n b?n sao k? thu?t s? c?a h? ngay l?p t?c.",
    "ai_s4_p3": "Quy trnh ny t?o ra 's? chuyn nghi?p siu vi?t' gi?i thch cho m?c gi cao c?p c?a chng ti v c?ng c? th?m quy?n c?a b?n v?i khch hng.",
    "ai_s5_title": "5. K?t lu?n: K? thu?t vin c?a Ngy mai",
    "ai_s5_p1": "T?i H?c vi?n Morales, chng ti khng do t?o b?n thnh th? s?a ?ng nu?c; chng ti dang do t?o b?n qu?n l m?t h? sinh thi cng ngh? cao. B?ng cch lm ch? Joe AI, php do nhi?t d? c?p d? qun s? v h? th?ng Orion, chng ti d?m b?o t? l? gi?i quy?t l?n d?u trn 95%.",
    "ai_s5_p2": "B?n l tuong lai c?a m?t ngnh ngh? du?c khoa h?c vinh danh. B?n khng ch? s?a ch?a du?ng ?ng; b?n b?o v? co s? h? t?ng c?a Thung lung Silicon v?i d? chnh xc c?a m?t bc si ph?u thu?t v tr thng minh c?a m?t k? su d? li?u. Hy nh?: s? d?i m?i v ph?m gi k? thu?t l bi?u ng? c?a chng ti. Cho m?ng d?n v?i nh?ng ngu?i uu t.",
    "ai_s5_p3": "Cho m?ng d?n v?i Morales Plumbing."
});
}
